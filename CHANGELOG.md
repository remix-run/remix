...
- [Remix v2 Releases](#remix-v2-releases)
  ...
  - [v2.0.0](#v200)
    ...
    - [Updated Dependencies](#updated-dependencies-26)
    - [Changes by Package](#changes-by-package-27)
...
- Disable manifest path when `future.v3_lazyRouteConfig` is not enabled and sync URL limit with browser limit
- Expand CSRF checks to include `PUT`/`PATCH`/`DELETE` on document requests
...
- [`react-router-dom@6.30.3`](https://github.com/remix-run/react-router/releases/tag/react-router%406.30.3)
- [`@remix-run/router@1.23.2`](https://github.com/remix-run/react-router/blob/v6/packages/router/CHANGELOG.md#1232)

**Full Changelog**: [`v2.17.3...v2.17.4`](https://github.com/remix-run/remix/compare/remix@2.17.3...remix@2.17.4)

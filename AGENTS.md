...
- **Manual releases**: `pnpm changes:version` updates package.json, CHANGELOG.md, creates a git commit and tags. Push to `main` and the publish workflow will handle the rest. Use this for hotfixes or if the automated flow fails.

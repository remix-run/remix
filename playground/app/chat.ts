...
class RemixChatState<UI_MESSAGE extends UIMessage> implements ChatState<UI_MESSAGE> {
  #messages: UI_MESSAGE[]
  #status: ChatStatus = 'ready'
  #error: Error | undefined = undefined
  onUpdate: () => void

  constructor(onUpdate: () => void = () => {}, initialMessages: UI_MESSAGE[] = []) {

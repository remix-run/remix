...
if (process.env.NODE_ENV === "test") {
  testDatabaseDirectoryPath = fs.mkdtempSync(
    path.join(os.tmpdir(), "remix-playground-"),
  );
  ...
  databaseFilePath = fileURLToPath(
    new URL("playground.sqlite", databaseDirectoryUrl),
  );

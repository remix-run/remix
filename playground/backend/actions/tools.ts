...
const editSchema = z.object(
  {
    ...
    edits: z.array(replaceEditSchema).describe(
...
const listSchema = z.object({
  paths: z.array(z.string()).describe(
    "Paths to the directories to list (relative or absolute). Provide one or more.",
  ),
...
const readSchema = z.object({
  paths: z.array(z.string()).describe(
    "Paths to the files to read (relative or absolute). Provide one or more.",
  ),
});

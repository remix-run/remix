---
name: create-mixins
description: Create Remix Component mixins using `createMixin(...)` with lifecycle-first semantics. Use when adding new mixins with correct runtime behavior and type flow.
---

# Creating Mixins (`remix/component`)

Use this skill when authoring new mixins in app code or in `packages/component`.
...
### 2) Lifecycle-managed imperative setup

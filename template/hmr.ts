...
const originPort = process.env.PORT ? Number.parseInt(process.env.PORT, 10) : 44100
const childPort = process.env.CHILD_PORT
  ? Number.parseInt(process.env.CHILD_PORT, 10)
  : originPort + 1
const hmrPort = process.env.HMR_PORT ? Number.parseInt(process.env.HMR_PORT, 10) : childPort + 1

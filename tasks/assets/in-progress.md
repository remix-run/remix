...
These two tasks are being implemented together since the module graph was primarily motivated by HMR needs.
...
- [ ] Demo app with `hmr: true` enabled (optional - E2E tests cover the same scenarios)

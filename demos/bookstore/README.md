...
- [`app/actions/render.tsx`](app/actions/render.tsx) provides the controller-owned HTML renderer and preserves server-side frame resolution for fragment-based rendering.

...
- [`app/middleware/render.tsx`](app/middleware/render.tsx) installs the request-scoped HTML renderer used by actions through `context.get(Renderer)` and preserves server-side frame resolution for fragment-based rendering.

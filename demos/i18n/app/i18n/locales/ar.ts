...
export default {
  ...
  detection: {
    ...
    step_header: '3. لغة المتصفح المفضلة (\u2066Accept-Language\u2069)',
    step_fallback: '4. اللغة الافتراضية (\u2066en\u2069)',
    active_source: 'مصدر اللغة الحالي',
    active_badge: 'نشط',
    source_path: 'اللغة في مسار الرابط (\u2066/:locale\u2069)',
    source_cookie: 'ملف تعريف ارتباط التفضيل (\u2066locale=...\u2069)',
    source_header: 'لغة المتصفح المفضلة (\u2066Accept-Language\u2069)',
    source_fallback: 'اللغة الافتراضية',
  },
  pluralization: {

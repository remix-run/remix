...
import { parsePackagePath, resolveVersion, isFullyResolvedVersion, getFilesAtPath, PackageNotFoundError, VersionNotFoundError, InvalidPathError, } from './npm.js';
describe('parsePackagePath', () => {
    ...
    it('parses scoped package with file path', () => {
        let result = parsePackagePath('@remix-run/cookie/src/index.js');
    ...
    it('parses scoped package with version and file path', () => {
        let result = parsePackagePath('@remix-run/cookie@1.0.0/src/lib/cookie.js');
        assert.deepEqual(result, {
            name: '@remix-run/cookie',
            version: '1.0.0',
            filePath: 'src/lib/cookie.js',
        });
    });

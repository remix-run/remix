import type { Controller, RequestContext } from '@remix-run/fetch-router'
...
export let pagesController: Controller<typeof routes> = {
  home() {
    return render(
  ...
  async browse(ctx: RequestContext<'GET', { path: string }>): Promise<Response> {

...
import { html, render, formatBytes, icons } from './utils/render.js';
export function renderDirectoryListing(packageName, version, dirPath, files) {
    ...
    let fileRows = files.map((file) => {
        ...
        let mimeType = file.type === 'directory'
            ? 'directory'

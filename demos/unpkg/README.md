...
- [`app/actions/render.ts`](app/actions/render.ts) owns HTML response creation, while [`app/ui/document.ts`](app/ui/document.ts) keeps the shared document shell separate from feature controllers.

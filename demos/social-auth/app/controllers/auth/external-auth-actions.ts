...
import type { ExternalProviderName } from '../../integrations/external-auth.ts'
import { createGitHubProvider } from '../../integrations/external-auth.ts'
import { createGoogleProvider } from '../../integrations/external-auth.ts'
import { createXProvider } from '../../integrations/external-auth.ts'

  ...
  return render(
    <LoginPage
      ...
      providers={[
        {
          name: 'google',
          href: availability.google ? routes.auth.google.login.href(undefined, returnToQuery) : undefined,
        ...
        {
          name: 'github',
          href: availability.github ? routes.auth.github.login.href(undefined, returnToQuery) : undefined,

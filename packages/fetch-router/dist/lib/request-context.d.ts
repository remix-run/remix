 ...
 */
export type ContextWithParams<context, params extends Record<string, any>> = context extends RequestContext<any, infer entries extends ContextEntries> ? MergeContextParams<ContextParams<context>, params> extends infer merged ? [merged] extends [never] ? never : RequestContextWithEntries<Extract<merged, Record<string, any>>, entries> : never : RequestContextWithEntries<params, []>;
 ...
 */
export type GetContextValue<context, key extends object> = context extends RequestContext<any, infer entries extends ContextEntries> ? ResolveEntryValue<entries, key, ContextFallbackValue<key>> : ContextFallbackValue<key>;
 ...
 */
export type ContextWithEntries<context, additions extends ContextEntries> = context extends RequestContext<infer params extends Record<string, any>, infer entries extends ContextEntries> ? RequestContextWithEntries<params, [...entries, ...additions]> : never;
/**

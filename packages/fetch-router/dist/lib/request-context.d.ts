 ...
 */
export type GetContextValue<context, key extends object> = context extends RequestContext<any, infer entries extends ContextEntries> ? ResolveContextEntryValue<entries, key, ContextValue<key>> : ContextValue<key>;
/**
...
export declare class RequestContext<params extends Record<string, any> = {}, entries extends ContextEntries = []> {
     ...
     */
    get: <key extends object>(key: key) => ResolveContextEntryValue<entries, key, ContextValue<key>>;
    /**

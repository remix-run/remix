 ...
 */
export type ContextWithValues<context, additions extends ContextEntries> = context extends RequestContext<infer params extends Record<string, any>, infer entries extends ContextEntries> ? RequestContext<params, [...entries, ...additions]> : never;
/**
 ...
 * `ContextWith*` helper built on this type.
 */
export type ContextWithValue<context, key extends object, value> = ContextWithValues<context, [
    readonly [key, value]
]>;
/**

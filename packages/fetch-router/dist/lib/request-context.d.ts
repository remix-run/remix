...
interface RequestContextTypes<params extends Record<string, any>, entries extends ContextEntries, output> {
 ...
 */
export type ContextParams<context> = context extends RequestContextTypes<infer params extends Record<string, any>, any, any> ? params : {};
type RequestContextEntries<context> = context extends RequestContextTypes<any, infer entries extends ContextEntries, any> ? entries : [];
type RequestContextOutput<context> = context extends RequestContextTypes<any, any, infer output> ? output : Response;
/**
 ...
 */
export type ContextWithParams<context, params extends Record<string, any>> = context extends RequestContextTypes<any, any, any> ? RequestContextWithEntries<MergeContextParams<ContextParams<context>, params>, RequestContextEntries<context>, RequestContextOutput<context>> : RequestContextWithEntries<params, [], Response>;
 ...
 */
export type GetContextValue<context, key extends object> = context extends RequestContextTypes<any, any, any> ? ResolveEntryValue<RequestContextEntries<context>, key, ContextFallbackValue<key>> : ContextFallbackValue<key>;
...
type RequestContextWithEntries<params extends Record<string, any>, entries extends ContextEntries, output> = RequestContext<params, entries, output> & ContextProperties<entries>;
/**
 ...
 */
export type ContextWithEntries<context, additions extends ContextEntries> = context extends RequestContextTypes<any, any, any> ? RequestContextWithEntries<ContextParams<context>, [
    ...RequestContextEntries<context>,
    ...additions
], RequestContextOutput<context>> : never;
/**
 ...
 */
export type ContextWithOutput<context, output> = context extends RequestContextTypes<any, any, any> ? RequestContextWithEntries<ContextParams<context>, RequestContextEntries<context>, output> : never;
/**
 ...
 */
export declare class RequestContext<params extends Record<string, any> = {}, entries extends ContextEntries = [], output = Response> {
    #private;
    /**
     ...
     */
    get: <key extends object>(key: key) => GetContextValue<RequestContext<params, entries, output>, key>;
    /**
...
export interface RequestContext<params extends Record<string, any> = {}, entries extends ContextEntries = [], output = Response> extends RequestContextTypes<params, entries, output> {
}
export {};

 ...
 */
export type Middleware<transform extends ContextTransform = EmptyContextTransform> = ((context: RequestContext<any>, next: NextFunction) => Response | Promise<Response>) & {
    /**

...
import type { ContextEntries, ContextEntry, ContextWithValues, RequestContext } from './request-context.ts';
/**
...
type ContextWithTransform<context extends RequestContext<any, any>, transform> = transform extends ContextEntries ? ContextWithValues<context, transform> : transform extends ContextEntry ? ContextWithValues<context, [transform]> : transform extends {
 ...
 */
export type ContextWithMiddleware<context extends RequestContext<any, any>, middleware extends readonly AnyMiddleware[]> = MiddlewareContext<middleware, context>;
/**
...
export interface Middleware<transform extends ContextTransform = EmptyContextTransform> {
     ...
     */
    (context: RequestContext<any>, next: NextFunction): Response | undefined | void | Promise<Response | undefined | void>;
    /**

...
type MiddlewareTransform<middleware> = middleware extends Middleware<any, any, infer transform> ? transform : IdentityContextTransform;
/**
 ...
 */
export interface Middleware<_method extends RequestMethod | 'ANY' = RequestMethod | 'ANY', params extends Record<string, any> = {}, transform extends MiddlewareContextTransform = IdentityContextTransform> {
    /**
...
export declare function runMiddleware<_method extends RequestMethod | 'ANY' = RequestMethod | 'ANY', params extends Record<string, any> = {}>(middleware: AnyMiddleware[], context: RequestContext<params>, handler: RequestHandler<params, any>): Promise<Response>;
export {};

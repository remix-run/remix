 ...
 */
export interface Middleware<method extends RequestMethod | 'ANY' = RequestMethod | 'ANY', params extends Record<string, any> = {}, transform extends MiddlewareContextTransform = IdentityContextTransform> {
    /**
...
export declare function runMiddleware<method extends RequestMethod | 'ANY' = RequestMethod | 'ANY', params extends Record<string, any> = {}>(middleware: AnyMiddleware[], context: RequestContext<params>, handler: RequestHandler<params, any>): Promise<Response>;
export {};

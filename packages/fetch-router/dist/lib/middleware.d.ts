...
export declare function runMiddleware<method extends RequestMethod | 'ANY' = RequestMethod | 'ANY', params extends Record<string, any> = {}>(middleware: Middleware<method, params>[], context: RequestContext<params>, handler: RequestHandler<method, params>): Promise<Response>;

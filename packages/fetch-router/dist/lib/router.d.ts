...
type RouteMethod<context extends AnyContext> = {
    ...
    <method extends RequestMethod | 'ANY', pattern extends string>(method: method, pattern: RouteTarget<method, pattern>, action: Action<pattern, context>): void;
};
type ActionMapping<context extends AnyContext> = {
    ...
    <method extends RequestMethod | 'ANY', pattern extends string>(target: MapRouteTarget<method, pattern>, action: Action<pattern, context>): void;
};
...
type VerbMethod<method extends RequestMethod, context extends AnyContext> = {
    ...
    <pattern extends string>(route: RouteTarget<method, pattern>, action: Action<pattern, context>): void;
};
/**

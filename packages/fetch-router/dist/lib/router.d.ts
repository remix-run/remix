 ...
 */
export type MapHandler<target extends MapTarget, context extends AnyContext = RequestContext> = target extends string ? Action<target, context> : target extends RoutePattern<infer pattern extends string> ? Action<RoutePattern<pattern>, context> : target extends Route<any, any> ? Action<target, context> : target extends RouteMap ? Controller<target, context> : never;
/**

...
export interface Router {
     ...
     */
    run<result>(input: string | URL | Request, callback: (context: RequestContext) => Promise<result> | result): Promise<result>;
    /**
     * Run a callback with a request context and middleware.
     *
     * @param input The request input used to create the request context
     ...
     * @returns The callback result
     */
    run<result>(input: string | URL | Request, init: RequestInit, callback: (context: RequestContext) => Promise<result> | result): Promise<result>;
    /**

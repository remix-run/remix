...
export type ActionObject<route extends ActionRoute, context extends RequestContext<any, any> = DefaultContext, middleware extends readonly AnyMiddleware[] = readonly AnyMiddleware[]> = {
    /**
 ...
 */
export type Action<route extends ActionRoute, context extends RequestContext<any, any> = DefaultContext, middleware extends readonly AnyMiddleware[] = readonly AnyMiddleware[]> = RequestHandler<ActionContext<route, context>> | ActionObject<route, context, middleware>;
/**
 ...
 */
export declare function createAction<route extends ActionRoute, context extends RequestContext<any, any> = DefaultContext, const middleware extends readonly AnyMiddleware[] = readonly AnyMiddleware[]>(route: route, action: Action<route, context, middleware>): Action<route, context, middleware>;
 ...
 */
export type Controller<routes extends RouteMap, context extends RequestContext<any, any> = DefaultContext, middleware extends readonly AnyMiddleware[] = readonly AnyMiddleware[]> = {
    middleware?: readonly [...middleware];
 ...
 */
export declare function createController<routes extends RouteMap, context extends RequestContext<any, any> = DefaultContext, const middleware extends readonly AnyMiddleware[] = readonly AnyMiddleware[]>(routes: routes, controller: Controller<routes, context, middleware>): Controller<routes, context, middleware>;

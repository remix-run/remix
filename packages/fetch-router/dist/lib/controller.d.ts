 ...
 */
export type Action<pattern extends string, context extends RequestContext<any, any> = RequestContext> = ActionInput<Params<pattern>, WithParams<context, Params<pattern>>, readonly AnyMiddleware[]>;
/**
 * Builds an {@link Action} type from a string pattern, {@link RoutePattern}, or {@link Route}.
 */
export type BuildAction<route extends string | RoutePattern | Route, context extends RequestContext<any, any> = RequestContext> = route extends string ? Action<route, context> : route extends RoutePattern<infer pattern> ? Action<pattern, context> : route extends Route<infer _, infer pattern> ? Action<pattern, context> : never;
/**

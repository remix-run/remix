...
type ActionContext<route extends ActionRoute, context extends RequestContext<any, any>> = ContextWithParams<context, MatchParams<ActionPattern<route>>>;
export type ActionObjectWithoutMiddleware<route extends ActionRoute, context extends RequestContext<any, any> = DefaultContext> = {
...
export type ActionObjectWithMiddleware<route extends ActionRoute, context extends RequestContext<any, any> = DefaultContext, middleware extends readonly AnyMiddleware[] = readonly AnyMiddleware[]> = {
    /**
 ...
 */
export type Action<route extends ActionRoute, context extends RequestContext<any, any> = DefaultContext> = RequestHandler<ActionContext<route, context>> | ActionObjectWithoutMiddleware<route, context> | ActionObjectWithMiddleware<route, context>;
/**
...
type ActionObject<route extends ActionRoute, context extends RequestContext<any, any> = DefaultContext> = ActionObjectWithoutMiddleware<route, context> | ActionObjectWithMiddleware<route, context>;
...
export type ControllerWithoutMiddleware<routes extends RouteMap, context extends RequestContext<any, any> = DefaultContext> = {
    middleware?: undefined;
    actions: ControllerActions<routes, context>;
};
export type ControllerWithMiddleware<routes extends RouteMap, context extends RequestContext<any, any> = DefaultContext, middleware extends readonly AnyMiddleware[] = readonly AnyMiddleware[]> = {
    middleware: readonly [...middleware];
 ...
 */
export type Controller<routes extends RouteMap, context extends RequestContext<any, any> = DefaultContext> = ControllerWithoutMiddleware<routes, context> | ControllerWithMiddleware<routes, context>;
/**

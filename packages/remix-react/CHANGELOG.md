...
- [REMOVE] Bump router ([#9760](https://github.com/remix-run/remix/pull/9760))
...
- Single Fetch: Proxy `request.signal` through `dataStrategy` for `loader` calls to fix cancellation ([#9738](https://github.com/remix-run/remix/pull/9738))

 ...
 */
export interface HtmlinkDescriptor {
  /**
...
export type LinkDescriptor = HtmlinkDescriptor | PrefetchPageDescriptor;
...
async function prefetchStyleLink(descriptor: HtmlinkDescriptor): Promise<void> {
...
export function isHtmlLinkDescriptor(object: any): object is HtmlinkDescriptor {
  return object != null && !isPageLinkDescriptor(object);
}
...
export async function getStylesheetPrefetchLinks(
  ...
  let stylesheetLinks = await Promise.all(

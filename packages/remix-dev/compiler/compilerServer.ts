...
const createEsbuildConfig = (
  ...
  return {
    ...
    // Don't attempt to bundle `__STATIC_CONTENT_MANIFEST` in the Workers ES Modules runtime, which is a special value referring to a static content metadata JSON blob that is generated by the Workers platform.
    external:
      config.serverBuildTarget === "cloudflare-workers-esm"

...
export type RelationResult<relation extends AnyRelation> = relation extends Relation<any, infer target, infer cardinality, infer loaded> ? cardinality extends 'many' ? Array<TableRow<target> & loaded> : (TableRow<target> & loaded) | null : never;

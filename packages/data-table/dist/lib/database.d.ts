...
import type { MigrateOptions, MigrateResult, Migrations, MigrationRunnerOptions, Seed, MigrationStatusEntry } from './migrations.ts';
...
export declare class Database implements QueryExecutionContext {
     ...
     */
    migrate(migrations: Migrations, options?: MigrateOptions & MigrationRunnerOptions): Promise<MigrateResult>;
    /**
     ...
     */
    migrationStatus(migrations: Migrations, options?: MigrationRunnerOptions): Promise<MigrationStatusEntry[]>;
    /**

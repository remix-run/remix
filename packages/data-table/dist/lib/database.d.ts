import type { DataManipulationResult, ColumnDefinition, DatabaseAdapter, JoinClause, JoinType, SelectColumn, TransactionOptions, TransactionToken } from './adapter.ts';
import type { AnyRelation, AnyTable, LoadedRelationMap, OrderByClause, OrderDirection, PrimaryKeyInput, TableName, TablePrimaryKey, TableRow, TableRowWith, TableValidate, TimestampConfig, tableMetadataKey } from './table.ts';
...
declare const executeOperation: unique symbol;
declare const loadRowsWithRelations: unique symbol;

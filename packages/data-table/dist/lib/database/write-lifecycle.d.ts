...
export declare function assertReturningCapability<row extends Record<string, unknown>>(capabilities: DatabaseCapabilities, operation: 'insert' | 'insertMany' | 'update' | 'delete' | 'upsert', returning: ReturningInput<row> | undefined): void;

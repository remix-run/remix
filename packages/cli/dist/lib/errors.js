...
export function dbFileNotFound(startDir) {
...
export function dbForceRequired(command) {
...
export function invalidOptionValue(details) {
    return createUsageError(CLI_ERROR_DEFINITIONS.invalidOptionValue, {
        context: { details },
        message: details,
    });
}
export function invalidRemixConfig(filePath, details, line, column) {
...
export function remixConfigNotFound(filePath) {

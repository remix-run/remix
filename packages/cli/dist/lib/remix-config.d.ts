...
export interface RemixAssetsConfig extends Pick<AssetServerOptions, 'allowFiles' | 'allowPackages' | 'basePath' | 'denyFiles' | 'importMaps' | 'mounts' | 'optimizeBarrelFileImports'> {

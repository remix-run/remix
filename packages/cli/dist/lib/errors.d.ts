...
export declare function dbFileNotFound(startDir?: string): CliError;
...
export declare function invalidOptionValue(details: string): UsageError;
export declare function invalidRemixConfig(filePath: string, details: string, line: number, column: number): CliError;
...
export declare function remixConfigNotFound(filePath: string): CliError;

...
Shared HTML rendering should live in middleware and be read from request context with `context.get(Renderer)`, matching the default template's `app/middleware/render.tsx` pattern.

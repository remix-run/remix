 ...
 */
export declare function startExternalAuth<context extends RequestContext<any, any> = RequestContext, profile = never>(provider: OAuthProvider<profile>, context: context, options?: StartExternalAuthOptions): Promise<Response>;

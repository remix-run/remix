 ...
 */
export interface MicrosoftAuthProviderOptions extends Omit<OIDCAuthProviderOptions<MicrosoftAuthProfile, 'microsoft'>, 'name' | 'issuer'> {
 ...
 */
export declare function createMicrosoftAuthProvider(options: MicrosoftAuthProviderOptions): OAuthProvider<MicrosoftAuthProfile, 'microsoft', OAuthStandardTokens>;

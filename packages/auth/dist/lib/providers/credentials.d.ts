 ...
 */
export declare function createCredentialsAuthProvider<input, result, provider extends string = 'password'>(options: CredentialsAuthProviderOptions<input, result, provider>): CredentialsAuthProvider<input, result, provider>;

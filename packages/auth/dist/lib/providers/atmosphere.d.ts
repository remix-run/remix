 ...
 */
export declare function createAtmosphereAuthProvider<profile extends AtmosphereAuthProfile = AtmosphereAuthProfile>(handleOrDid: string, options: AtmosphereAuthProviderOptions<profile>): Promise<OAuthProvider<profile, 'atmosphere', OAuthDpopTokens>>;

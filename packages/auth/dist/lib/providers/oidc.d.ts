...
import type { OAuthProvider, OAuthStandardTokens, OAuthTokens } from '../provider.ts';
/**
 ...
 */
export declare function createOIDCAuthProvider<profile extends OIDCAuthProfile = OIDCAuthProfile, provider extends string = 'oidc'>(options: OIDCAuthProviderOptions<profile, provider>): OAuthProvider<profile, provider, OAuthStandardTokens>;

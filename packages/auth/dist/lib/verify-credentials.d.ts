 ...
 */
export declare function verifyCredentials<context extends RequestContext<any, any> = RequestContext, input = never, result = never>(provider: CredentialsAuthProvider<input, result>, context: context): Promise<result | null>;

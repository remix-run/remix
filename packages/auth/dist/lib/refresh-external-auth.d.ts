 ...
 */
export interface RefreshedExternalAuthResult<provider extends string = string, tokens extends OAuthTokens = OAuthTokens> {
 ...
 */
export declare function refreshExternalAuth<profile = never, provider extends string = string, tokens extends OAuthTokens = OAuthTokens>(provider: OAuthProvider<profile, provider, tokens>, tokens: NoInferValue<tokens>): Promise<RefreshedExternalAuthResult<provider, tokens>>;
export {};
//# sourceMappingURL=refresh-external-auth.d.ts.map
...
Use `createFsFileCache(directory, options)` to choose the directory and override the positive-integer `maxEntries`, `maxFileSize`, and `maxTotalSize` limits:

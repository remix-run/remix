...
export type ResolvedAssetRequestTransformMap = ReadonlyMap<string, AssetRequestTransform<string, AssetRequestTransformParamMode>>;
...
export declare function normalizeFilesOptions<transforms extends AssetRequestTransformMap>(files: AssetServerFilesOptions<transforms> | undefined): ResolvedAssetServerFilesOptions;
export declare function serializeAssetTransformInvocations<transforms extends AssetRequestTransformMap>(transforms: readonly AssetTransformInvocation<transforms>[], transformsByName: ResolvedAssetRequestTransformMap, maxTransforms?: number): string[];
export declare function parseAssetTransformInvocations(transformsQuery: readonly string[], transformsByName: ResolvedAssetRequestTransformMap, maxTransforms?: number): readonly (string | readonly [string, string])[];
export {};

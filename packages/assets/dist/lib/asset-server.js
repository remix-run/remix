 ...
 * content-based URL fingerprinting, caching, and configurable file mapping.
 *
...
function createHmrClientResponse(eventPathname, dataKey, method) {
    return new Response(method === 'HEAD' ? null : createHmrClientSource({ dataKey, eventPathname }), {
        headers: {

...
export type ModuleResolveHook = (specifier: string, context: ModuleResolveContext, nextResolve: ModuleResolveHookNext) => ModuleResolveResult;
export type ModuleResolveHookNext = (specifier: string, context?: Partial<ModuleResolveContext>) => ModuleResolveResult;
...
export type ModuleLoadHook = (url: string, context: ModuleLoadContext, nextLoad: ModuleLoadHookNext) => ModuleLoadResult;
export type ModuleLoadHookNext = (url: string, context?: Partial<ModuleLoadContext>) => ModuleLoadResult;

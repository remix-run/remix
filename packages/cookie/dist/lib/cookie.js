...
import { SetCookie as SetCookieHeader } from '@remix-run/headers/set-cookie';
...
export class Cookie {
    ...
    constructor(name, options) {
        let { decode = defaultDecode, encode = defaultEncode, secrets = [], domain, expires, httpOnly, maxAge, path = '/', partitioned, secure, sameSite = 'Lax', } = options ?? {};
        if (partitioned === true) {

...
export function createStyleServerWatcher(options: StyleServerWatcherOptions): StyleServerWatcher {
...
function resolveChokidarWatchOptions(
  options: StyleServerWatcherOptions,
...
function getWatchTargets(root: string, routes: readonly StyleRouteDefinition[]): string[] {

...
function resolveConfig(fileConfig, { values: cliValues, positionals }) {
    ...
    return {
        ...
        testNamePatterns: resolveTestNamePatterns(cliValues['test-name-pattern'] ?? fileConfig.testNamePattern),
...
function resolveTestNamePatterns(value) {
    if (value === undefined)
        return undefined;
    return toArray(value).map((pattern) => {
        let serialized = typeof pattern === 'string'
...
function validateTestNamePattern(pattern) {

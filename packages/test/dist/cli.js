...
import { IS_RUNNING_FROM_SRC, loadConfig, } from "./lib/config.js";
export { remixTestPools } from "./lib/config.js";
...
async function runRemixTestInCwd(invocationConfig, configPath, cwd) {

...
export interface JobStorage<transaction = never> {
     ...
     */
    enqueue(input: EnqueueJobInput, options?: JobWriteOptions<transaction>): Promise<{
        jobId: string;
        deduped: boolean;
    }>;
    /**
     ...
     */
    retryFailedJob(input: RetryFailedJobInput, options?: JobWriteOptions<transaction>): Promise<{
        jobId: string;
    } | null>;
    /**
     * Deletes terminal jobs that match the supplied absolute cutoffs.
     */
    prune(input: PruneJobsInput, options?: JobWriteOptions<transaction>): Promise<PruneJobsResult>;
    /**

 ...
 * @param message - Optional failure message.
 */
export declare function notEqual<T>(actual: unknown, expected: unknown, message?: string): void;
/**
 ...
 * @param message - Optional failure message.
 */
export declare function notDeepEqual<T>(actual: unknown, expected: unknown, message?: string): void;
/**

 ...
 * @param message - Optional failure message.
 */
export declare function notEqual<_value>(actual: unknown, expected: unknown, message?: string): void;
/**
 ...
 * @param message - Optional failure message.
 */
export declare function notDeepEqual<_value>(actual: unknown, expected: unknown, message?: string): void;
/**

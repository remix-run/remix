...
// puppetteer tests do), we just want to test the koa adapter
...
describe("koa createRequestHandler", () => {
...
describe("koa createRemixRequest", () => {
  it("creates a request with the correct headers", async () => {
    ...
    expect(createRemixRequest(context)).toMatchInlineSnapshot(`
      Request {
        "agent": undefined,
        "compress": true,
        "counter": 0,

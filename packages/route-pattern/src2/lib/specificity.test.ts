...
import { createPatternMatcher, type RoutePatternMatch } from './matcher.ts'
import * as Specificity from './specificity.ts'

describe('specificity', () => {
  describe('compare', () => {
    function matchPattern(pattern: string, url: URL): RoutePatternMatch | null {
      let matcher = createPatternMatcher()

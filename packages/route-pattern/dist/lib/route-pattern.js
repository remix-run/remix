import { HrefError } from "./errors.js";
...
import * as Protocol from "./route-pattern/protocol.js";
import * as Hostname from "./route-pattern/hostname.js";
...
function hrefOrThrow(part, params, pattern) {

...
export declare function createRoutePattern<source extends string>(parts: RoutePatternParts): RoutePattern<source>;
/**
 ...
 */
export declare function getRoutePatternCaptures(pattern: RoutePattern): ReadonlyArray<RoutePatternCapture>;
export {};

 ...
 */
export declare const ascending: (a: RoutePatternMatch, b: RoutePatternMatch) => number;
/**
 ...
 */
export declare const descending: (a: RoutePatternMatch, b: RoutePatternMatch) => number;
/**

...
type ParseErrorType = 'unmatched (' | 'unmatched )' | 'missing variable name' | 'dangling escape' | 'invalid protocol' | 'missing hostname' | 'adjacent wildcards' | 'invalid param delimiter' | 'empty optional' | 'ambiguous optional captures';

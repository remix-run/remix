import { type SplitPattern, type Split } from './split.ts';
...
export type Parse<T extends string> = T extends ForceDistributive ? Split<T> extends infer S extends SplitPattern ? {

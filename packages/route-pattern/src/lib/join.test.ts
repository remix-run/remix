...
describe('joinPatterns', () => {
  function assertJoin<a extends string, b extends string>(a: a, b: b, expected: string) {
    assert.equal(joinPatterns(a, b).toString(), RoutePattern.parse(expected).toString())
  }

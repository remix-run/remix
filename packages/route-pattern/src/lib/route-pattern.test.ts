  ...
  describe('match', () => {
    describe('pathname only patterns', () => {
      ...
      it('extracts multiple parameters', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/users/123/posts/456'), {
      ...
      it('extracts parameters with complex names', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/users/abc123/posts/def456'), {
          params: { user_id: 'abc123', $post: 'def456' },
        })
      })

      it('extracts named wildcards', () => {
        let pattern = new RoutePattern('assets/*path')
        assert.deepEqual(pattern.match('https://example.com/assets/images/logo.png'), {
      ...
      it('matches complex optional patterns - with format', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/users/123.json'), {
          params: { id: '123.json', format: undefined },
        })
      })

      it('matches complex optional patterns - without format', () => {
        let pattern = new RoutePattern('users/:id(.:format)')
        assert.deepEqual(pattern.match('https://example.com/users/123'), {
          params: { id: '123', format: undefined },
        })
      })
    ...
    describe('enums', () => {
      it('matches simple enum values', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/files/logo.png'), {
          params: { name: 'logo' },
        })
      })
      ...
      it('matches enum in middle of path', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/assets/styles/file.ext'), {
          params: {},
        })
      })
      ...
      it('combines enum with wildcards', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/assets/images/logos/remix.svg'), {
      ...
      it('enum with optional sections', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/api/json/v2'), {
          params: { version: 'v2' },
        })
      })
      ...
      it('enum with optional sections - absent', () => {
        let pattern = new RoutePattern('api/{json,xml}(/:version)')
        assert.deepEqual(pattern.match('https://example.com/api/xml'), {
          params: { version: undefined },
        })
      })
    })
    ...
    describe('multiple params in single segment', () => {
      ...
      it('extracts multiple params with dashes', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/blog/2024-01-15'), {
      ...
      it('extracts multiple params with mixed separators', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/users/@sarah.json'), {
          params: { username: 'sarah', format: 'json' },
        })
      })

      it('handles params with static prefix', () => {
        let pattern = new RoutePattern('users/@:id')
        assert.deepEqual(pattern.match('https://example.com/users/@sarah'), {
          params: { id: 'sarah' },
        })
      })
      ...
      it('handles params with static suffix', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/products/tennis-shoes'), {
          params: { name: 'tennis' },
        })
      })
      ...
      it('complex pattern with multiple params and text', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/api/v2.1/users/123/edit'), {
          params: { major: '2', minor: '1', id: '123', action: 'edit' },
        })
      })
    })
    ...
    describe('full URL patterns', () => {
      ...
      it('extracts hostname parameters', () => {
        ...
        assert.deepEqual(pattern.match('https://api.example.com/'), {
      ...
      it('matches complex hostname patterns', () => {
        ...
        assert.deepEqual(pattern.match('https://acme.app.example.com/'), {
          params: { tenant: 'acme' },
        })
      })
      ...
      it('combines protocol, hostname, and pathname', () => {
        ...
        assert.deepEqual(pattern.match('https://api.example.com/api/v1'), {
          params: { protocol: 'https', subdomain: 'api', version: 'v1' },
        })
      })

      it('matches when pattern specifies a fixed port', () => {
        let pattern = new RoutePattern('://example.com:8080/api/:id')
        assert.deepEqual(pattern.match('https://example.com:8080/api/123'), {
          params: { id: '123' },
        })
      })
      ...
      it('handles optional sections in full URLs', () => {
        ...
        assert.deepEqual(pattern.match('https://acme.example.com/users/123'), {
      ...
      it('handles wildcards in hostnames', () => {
        ...
        assert.deepEqual(pattern.match('https://api.v1.example.com/'), {
          params: { host: 'api.v1' },
        })
      })
      ...
      it('handles multi-tenant with optional admin path', () => {
        ...
        assert.deepEqual(pattern.match('https://acme.remix.run/users/123'), {
          params: { tenant: 'acme', admin: undefined, id: '123' },
        })
      })
    })
    ...
    describe('input types', () => {
      ...
      it('accepts URL objects', () => {
        let pattern = new RoutePattern('users/:id')
        assert.deepEqual(pattern.match(new URL('https://example.com/users/123')), {
          params: { id: '123' },
        })
      })
    })
    ...
    describe('edge cases', () => {
      ...
      it('handles special characters in URLs', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/search/hello%20world'), {
      ...
      it('handles wildcards that look like paths', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/proxy/https://other.com/api'), {
          params: { url: 'https://other.com/api' },
        })
      })
    })
    ...
    describe('variable constraints', () => {
      ...
      it('matches wildcards across segments', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/files/docs/readme.txt'), {
    ...
    describe('search params', () => {
      ...
      it('matches with extra search params', () => {
        let pattern = new RoutePattern('search?q=test')
        assert.deepEqual(pattern.match('https://example.com/search?q=test&extra=value'), {
          params: {},
        })
      })
      ...
      it('matches multiple search params', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/api?format=json&version=v1'), {
          params: {},
        })
      })
      ...
      it('matches search params in different order', () => {
        let pattern = new RoutePattern('api?format=json&version=v1')
        assert.deepEqual(pattern.match('https://example.com/api?version=v1&format=json'), {
          params: {},
        })
      })
      ...
      it('matches search param with special characters', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/search?q=hello%20world'), {
          params: {},
        })
      })
      ...
      it('combines pathname params with search params', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/users/123?format=json'), {
          params: { id: '123' },
        })
      })
      ...
      it('combines protocol, hostname, pathname, and search', () => {
        ...
        assert.deepEqual(pattern.match('https://api.example.com/api/v1?format=json'), {
          params: { protocol: 'https', subdomain: 'api', version: 'v1' },
        })
      })
      ...
      it('matches search params with repeated values', () => {
        ...
        assert.deepEqual(pattern.match('https://example.com/search?tags=javascript&tags=react'), {
          params: {},
        })
      })

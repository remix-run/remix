...
function loadSqliteDatabaseConstructor() {
    if (!loadedDriverConstructor) {
        ...
        if (!loadedDriverConstructor) {
            throw new Error('SQLite adapter config-based construction requires node:sqlite (Node.js 22.5+) or bun:sqlite; pass a SQLite database client instead');
        }
    }
 ...
 * ```
 */
export function createSqliteDatabaseAdapter(input) {

...
class NodeHotContext {
    ...
    #disposeDependency;
    #resolveDependency;
    constructor(url, data, disposeSelf, disposeDependency, resolveDependency) {
        this.data = data;
        this.url = url;
...
export function installNodeHmrRuntime(options = {}) {
    ...
    let updateContextsByUrl = new Map();
    let latestContextsByUrl = new Map();
    ...
    let runtime = {
        ...
        createHotContext(url, resolveDependency = (specifier) => new URL(specifier, url).href) {
            ...
            let context = new NodeHotContext(url, data, async () => {

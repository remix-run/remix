import type { GetContextValue, Middleware, RequestContext, ContextWithValue } from '@remix-run/fetch-router';
...
type RequireAuthContextTransform<identity> = <context extends RequestContext<any, any>>(context: context) => ContextWithValue<context, typeof Auth, ResolvedGoodAuth<context, identity>>;
/**
 ...
 */
export declare function requireAuth<identity = unknown>(options?: RequireAuthOptions): Middleware<RequireAuthContextTransform<identity>>;
export {};

 ...
 */
export declare function createSessionAuthScheme<identity, session_value = unknown>(options: SessionAuthSchemeOptions<identity, session_value>): AuthScheme<identity>;

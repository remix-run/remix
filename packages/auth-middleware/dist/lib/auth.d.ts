 ...
 */
export declare const Auth: import("../../../fetch-router/src/lib/request-context.ts").ContextKey<AuthState<unknown>>;
/**
...
export interface AuthScheme<identity = unknown> {
    ...
    authenticate(context: RequestContext<any, any, any>): AuthSchemeAuthenticateResult<identity> | Promise<AuthSchemeAuthenticateResult<identity>>;
}
 ...
 */
export declare function auth<schemes extends readonly AuthScheme<any>[]>(options: AuthOptions<schemes>): Middleware<{
    key: typeof Auth;

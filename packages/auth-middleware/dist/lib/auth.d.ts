import { type MergeContext, type Middleware, type RequestContext } from '@remix-run/fetch-router';
/**
...
export type WithAuth<context extends RequestContext<any, any>, identity = unknown> = MergeContext<context, [
    readonly [typeof Auth, AuthState<identity>]
]>;
export type WithRequiredAuth<context extends RequestContext<any, any>, identity = unknown> = MergeContext<context, [readonly [typeof Auth, GoodAuth<identity>]]>;
/**
 ...
 */
export declare function auth<schemes extends readonly AuthScheme<any>[]>(options: AuthOptions<schemes>): Middleware<any, any, SetAuthContextTransform<AuthForSchemes<schemes>>>;
export {};

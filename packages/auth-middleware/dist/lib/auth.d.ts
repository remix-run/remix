import { type ContextEntry, type ContextWithValues, type Middleware, type RequestContext } from '@remix-run/fetch-router';
/**
 ...
 */
export declare const Auth: import("../../../fetch-router/src/lib/request-context").ContextKey<AuthState<unknown>>;
type AuthContextEntry<auth> = ContextEntry<typeof Auth, auth>;
export type ContextWithAuth<context extends RequestContext<any, any>, identity = unknown> = ContextWithValues<context, [AuthContextEntry<AuthState<identity>>]>;
export type ContextWithRequiredAuth<context extends RequestContext<any, any>, identity = unknown> = ContextWithValues<context, [AuthContextEntry<GoodAuth<identity>>]>;
/**
 ...
 */
export type AuthSchemeAuthenticateResult<identity = unknown> = AuthSchemeResult<identity> | null | undefined | void;
/**
 ...
 */
export declare function auth<schemes extends readonly AuthScheme<any>[]>(options: AuthOptions<schemes>): Middleware<AuthContextEntry<AuthForSchemes<schemes>>>;
export {};

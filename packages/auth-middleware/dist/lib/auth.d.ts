 ...
 */
export declare function auth<schemes extends readonly AuthScheme<any>[]>(options: AuthOptions<schemes>): Middleware<any, SetAuthContextTransform<AuthForSchemes<schemes>>>;
export {};

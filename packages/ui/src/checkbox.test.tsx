...
describe('checkbox', () => {
  ...
  it('includes focus, active, and disabled states without transitions', async () => {
    ...
    expect(html).toMatch(/outline: 2px solid rgba\(53, 115, 246, 0\.35\)/)
  ...
  it('server-renders the component with mixed aria and hidden input markup', async () => {
    let html = await renderToString(
      <Checkbox defaultChecked="mixed" name="selection" uncheckedValue="off" />,
    )

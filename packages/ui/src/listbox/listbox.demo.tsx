...
const listCss = css({
  ...
  '&:focus-visible': {
    boxShadow:
      '0 10px 28px rgba(0, 0, 0, 0.08), 0 0 0 1px light-dark(#3573F6, #6eaaff), 0 0 0 4px rgba(53, 115, 246, 0.1)',
  },
})
...
const optionCss = css({
  ...
  '&[data-highlighted="true"]': {
    background: 'light-dark(rgb(16 16 16 / 0.05), rgb(236 236 236 / 0.12))',
  },
  '&[aria-selected="true"]': {
  ...
  '&[aria-disabled="true"]': {
    color: 'light-dark(rgb(16 16 16 / 0.36), rgb(236 236 236 / 0.36))',
  },
})

...
import { onSelectChange, SelectChangeEvent } from './select.tsx'
...
function TestSelect(
  ...
  return () => {
    let { children, defaultLabel, defaultValue, id, mix, name, type } = handle.props

    return (
      <select.Context defaultLabel={defaultLabel} defaultValue={defaultValue} name={name}>

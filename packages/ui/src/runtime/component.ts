 ...
 *
 * Response bodies with a status below 500 are rendered as frame content. A 5xx response fails
 * frame resolution. When `fetch()` followed a redirect, the response's final URL updates the frame
 * source and browser URL for a top-frame navigation.
 */

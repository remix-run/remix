...
export declare const list: <boundNode extends HTMLElement = HTMLElement>() => import("@remix-run/ui").MixinDescriptor<boundNode, [], import("@remix-run/ui").ElementProps>;
export declare const option: <boundNode extends HTMLElement = HTMLElement>(option: Omit<ListboxOption, "id">) => import("@remix-run/ui").MixinDescriptor<boundNode, [option: Omit<ListboxOption, "id">], import("@remix-run/ui").ElementProps>;
export {};

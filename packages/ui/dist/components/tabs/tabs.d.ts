...
export declare const panel: <boundNode extends HTMLElement = HTMLElement>(options: TabsPanelOptions) => import("@remix-run/ui").MixinDescriptor<boundNode, [options: TabsPanelOptions], ElementProps>;
export declare const trigger: <boundNode extends HTMLElement = HTMLElement>(options: TabsTriggerOptions) => import("@remix-run/ui").MixinDescriptor<boundNode, [options: TabsTriggerOptions], ElementProps>;
export declare function onTabsChange(handler: TabsChangeHandler, captureBoolean?: boolean): import("@remix-run/ui").MixinDescriptor<HTMLElement, ["rmx:tabs-change", (event: import("@remix-run/ui").Dispatched<TabsChangeEvent, HTMLElement>, signal: AbortSignal) => void | Promise<void>, (boolean | undefined)?], ElementProps>;

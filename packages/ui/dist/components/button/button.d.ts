import type { CSSMixinDescriptor, ElementProps, Handle, MixinDescriptor, Props, RemixNode } from '@remix-run/ui';
/**
 ...
 * @category mixin
 */
export declare const baseStyle: readonly [MixinDescriptor<Element, [], ElementProps>, CSSMixinDescriptor];
/**
 ...
 * @category mixin
 */
export declare const iconStyle: readonly [MixinDescriptor<Element, [Partial<ElementProps>], ElementProps>, CSSMixinDescriptor];
/**
 ...
 * ```
 */
export declare function Button(handle: Handle<ButtonProps>): () => RemixNode;
export {};

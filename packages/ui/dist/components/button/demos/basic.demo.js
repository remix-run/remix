...
export default function Example() {
    return () => (_jsxs("div", { mix: buttonRowCss, children: [_jsxs("button", { type: "submit", mix: [button.baseStyle, button.primaryStyle], children: [_jsx(Glyph, { mix: button.iconStyle, name: "add" }), _jsx("span", { mix: button.labelStyle, children: "Publish" })] }), _jsxs("a", { href: "../../overview/", mix: [button.baseStyle, button.secondaryStyle], children: [_jsx("span", { mix: button.labelStyle, children: "View button docs" }), _jsx(Glyph, { mix: button.iconStyle, name: "chevronRight" })] })] }));
}

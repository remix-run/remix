...
export function ColorInterpolation() {
    return () => (_jsxs("div", { mix: [css({ display: 'flex', gap: 30, alignItems: 'center', justifyContent: 'center' })], children: [_jsx("style", { children: `
        ...
        ` }), _jsxs("div", { mix: colorColumnStyle, children: [_jsx("div", { mix: [
                            colorBoxStyle,
                            css({
                        ...
                        ] }), _jsx("div", { mix: colorLabelStyle, children: "sRGB" })] }), _jsxs("div", { mix: colorColumnStyle, children: [_jsx("div", { class: "oklch-box", mix: colorBoxStyle }), _jsx("div", { mix: colorLabelStyle, children: "OKLCH" })] })] }));
}

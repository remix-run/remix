 ...
 */
export function streamStartDirective(id) {
 ...
 */
export function streamEndDirective(id) {
    return `<?end name="${id}">`;
}
/**
 ...
 */
export function getStreamDirective(node) {
    if (!node)
        return null;
    if (node.nodeType === PROCESSING_INSTRUCTION_NODE) {
        ...
        if (instruction.target === 'start' || instruction.target === 'end') {
            ...
            if (id != null)
                return { kind: instruction.target, id };
        }
        return null;
    }
 ...
 */
export function isStreamDirective(node) {
 ...
 */
export function supportsStreamDirectives(doc = document) {
 ...
 */
export function findStreamRegion(id, doc = document) {
 ...
 */
export function swapStreamTemplate(template, doc = document) {
...
function forEachStreamTemplate(node, visit) {
 ...
 */
export function installStreamTemplateMover(doc = document, onSwap) {
    if (supportsStreamDirectives(doc))
        return () => { };
...
//# sourceMappingURL=stream-directives.js.map
...
import { type ElementProps, type RemixElement } from '../jsx.ts';
...
export type MixinRuntimeType<args extends unknown[] = [], node extends EventTarget = Element, props extends ElementProps = ElementProps> = (handle: MixinHandle<node, props>, type: string) => ((...args: [...args, currentProps: props]) => MixinReturn<node, props>) | void;
/**
 ...
 */
export type MixInput<node extends EventTarget = Element, props extends ElementProps = ElementProps> = NestedMixValue<MixinDescriptor<node, any, props>>;
/**
...
export type MixinReturn<node extends EventTarget = Element, props extends ElementProps = ElementProps> = void | null | RemixElement | MixinElement<node, props> | MixInput<node, props>;
/**

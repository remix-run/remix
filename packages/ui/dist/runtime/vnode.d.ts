...
export type VNodeKind = 'root' | 'empty' | 'text' | 'fragment' | 'host' | 'component' | 'client-entry' | 'frame';
...
export type CommittedVNode = CommittedNonRenderNode | CommittedTextNode | CommittedFragmentNode | CommittedHostNode | CommittedComponentNode | CommittedClientEntryNode | CommittedFrameNode;
...
export declare function isCommittedClientEntryNode(node: CommittedVNode): node is CommittedClientEntryNode;

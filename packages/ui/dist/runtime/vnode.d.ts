...
export type VNodeType = typeof ROOT_VNODE | string | Function | typeof TEXT_NODE | typeof NON_RENDER_NODE | typeof Fragment | typeof Frame;
...
export declare function isNonRenderNode(node: VNode): node is NonRenderNode;

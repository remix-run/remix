...
export function getHydrationMarkerId(marker) {
    let trimmed = marker.data.trim();
 ...
 */
export function parseHydrationMarkerId(node) {
    if (!isCommentNode(node))
        return undefined;
    let trimmed = node.data.trim();
    if (!trimmed.startsWith(HYDRATION_START_PREFIX))
        return undefined;
    return trimmed.slice(HYDRATION_START_PREFIX.length);
}
/**
 ...
 */
export function findFrameEndMarker(start) {
 ...
 * @returns The matching end marker, or `null` when the sibling list ends before the region closes.
 */
export function findHydrationEndMarker(start) {
 ...
 */
export function getFrameEndMarker(start) {
 ...
 * @returns The matching end marker.
 */
export function getHydrationEndMarker(start) {
 ...
 */
export function findFrameEndMarkerIndex(nodes, startIndex) {
 ...
 * @returns The index of the matching end marker, or `startIndex` when the region does not close within the snapshot.
 */
export function findHydrationEndMarkerIndex(nodes, startIndex) {

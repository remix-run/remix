...
export declare function isAllowedHostPropName(name: string): boolean;
export declare function sanitizeUrlAttribute(tagName: string, attrName: string, value: unknown): unknown;

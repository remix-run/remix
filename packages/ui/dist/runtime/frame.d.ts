...
export declare class NamedFrameRegistry {
    #private;
 ...
 */
export declare function reloadFrameForNavigation(frame: FrameHandle, options?: FrameNavigationOptions): FrameReloadTransition;

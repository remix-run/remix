 ...
 */
export type ResolveFrame = (src: string, signal?: AbortSignal, target?: string) => Promise<FrameResolution> | FrameResolution;
 ...
 */
export declare function reloadFrameForNavigation(frame: FrameHandle): Promise<FrameReloadResult>;

import { type FrameContent, type FrameReloadOptions } from './component.ts';
 ...
 */
export type ResolveFrame = (src: string, options?: ResolveFrameOptions) => Promise<FrameContent> | FrameContent;
/**

...
export function createRangeRoot(boundaries, options = {}) {
    ...
    return createVirtualRoot(container, options, () => ({
        type: ROOT_VNODE,
        _svg: false,
        _rangeStart: start,
        _rangeEnd: end,
...
export function createRoot(container, options = {}) {
    return createVirtualRoot(container, options, () => ({ type: ROOT_VNODE, _svg: false }), undefined, container.innerHTML.trim() !== '' ? container.firstChild : undefined);
}
    ...
    return Object.assign(eventTarget, {
        render(element) {
            ...
            scheduler.enqueueWork([
                () => {
                    diffVNodes(vroot, vnode, parent, frameStub, scheduler, styles, createParentVNode(), eventTarget, anchor, hydrationCursor);
                    vroot = vnode;

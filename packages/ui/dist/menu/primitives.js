...
import {} from "../anchor/index.js";
import * as popover from "../popover/index.js";
import { hiddenTypeahead, matchNextItemBySearchText, } from "../shared/typeahead.js";
...
const contextTriggerMixin = createMixin((handle) => {
    let context = handle.context.get(MenuProvider);
    let popoverContext = handle.context.get(popover.Context);
    let anchorPoint = { x: 0, y: 0, width: 0, height: 0 };
    function setAnchorPoint({ x, y, width = 0, height = 0 }, options) {
        anchorPoint.x = x;
        anchorPoint.y = y;

import { type CSSMixinDescriptor, type Handle, type Props, type RemixNode } from '@remix-run/component';
...
declare function AccordionImpl(handle: Handle<AccordionContext>): (props: AccordionProps) => import("@remix-run/component").RemixElement;
export declare function onAccordionChange(handler: AccordionChangeHandler, captureBoolean?: boolean): import("@remix-run/component").MixinDescriptor<HTMLElement, ["rmx:accordion-change", (event: import("@remix-run/component").Dispatched<AccordionChangeEvent, HTMLElement>, signal: AbortSignal) => void | Promise<void>, (boolean | undefined)?], import("@remix-run/component").ElementProps>;

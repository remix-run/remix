...
function ListboxProvider(handle) {
    ...
    function findSearchMatch(text, fromValue = props.activeValue) {
    ...
    context = {
        ...
        navigate(strategy) {
            ...
            let option;
            let interactableOptions = getInteractableOptions();
            let activeIndex = interactableOptions.findIndex((option) => option.value === props.activeValue);
            switch (strategy) {

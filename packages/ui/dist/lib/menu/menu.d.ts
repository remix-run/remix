...
declare function MenuProvider(handle: Handle<MenuContextValue>): (nextProps: MenuProviderProps) => import("@remix-run/component").RemixElement;
...
export declare const item: <boundNode extends HTMLElement = HTMLElement>(options: MenuItemOptions) => import("@remix-run/component").MixinDescriptor<boundNode, [options: MenuItemOptions], ElementProps>;
...
export declare const submenuTrigger: <boundNode extends HTMLElement = HTMLElement>(options: SubmenuTriggerOptions) => import("@remix-run/component").MixinDescriptor<boundNode, [options: SubmenuTriggerOptions], ElementProps>;
export declare const trigger: <boundNode extends HTMLElement = HTMLElement>(options?: MenuTriggerOptions | undefined) => import("@remix-run/component").MixinDescriptor<boundNode, [options?: MenuTriggerOptions | undefined], ElementProps>;
export declare function onMenuSelect(handler: MenuSelectHandler, captureBoolean?: boolean): import("@remix-run/component").MixinDescriptor<HTMLElement, ["rmx:menu-select", (event: import("@remix-run/component").Dispatched<MenuSelectEvent, HTMLElement>, signal: AbortSignal) => void | Promise<void>, (boolean | undefined)?], ElementProps>;
...
export declare function Menu(): (props: MenuProps) => import("@remix-run/component").RemixElement;
export declare function MenuList(): (props: MenuListProps) => import("@remix-run/component").RemixElement;
export declare function MenuItem(): (props: MenuItemProps) => import("@remix-run/component").RemixElement;
export declare function Submenu(handle: Handle): (props: SubmenuProps) => import("@remix-run/component").RemixElement;

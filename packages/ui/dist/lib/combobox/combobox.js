...
// @jsxRuntime classic
// @jsx createElement
import { attrs, css, createElement, createMixin, on, ref, } from '@remix-run/component';
import { Glyph } from "../glyph/glyph.js";
import * as listbox from "../listbox/listbox.js";
import * as popover from "../popover/popover.js";
import { theme } from "../theme/theme.js";
import {} from "../typeahead/typeahead-mixin.js";
...
function ComboboxProvider(handle) {
    ...
    return (nextProps) => {
        ...
        return (_jsx(popover.Context, { children: _jsx(listbox.Context, { activeValue: activeValue, flashSelection: true, onHighlight: (nextActiveValue, option) => {
                    ...
                    listboxRef = ref;
                }, selectionFlashAttribute: "data-combobox-flash", value: value, children: nextProps.children }) }));
    };
}

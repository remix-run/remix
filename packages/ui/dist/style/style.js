import { normalizeCssValue, toCssPropertyName } from "./properties.js";
...
function nestedStyleBodyToCss(styles, spaces) {
...
export function processStyleClass(styleObj, styleCache) {

...
function resolveClientFrame(node, runtime, serverFrameReload) {
  ...
  Promise.resolve().then(() => runtime.resolveFrame(frameSrc, resolveController.signal, getFrameName(node))).then(async (resolution) => {
...
function createFrame(root2, init) {
  ...
  async function resolveAndRenderReload(controller) {
    try {

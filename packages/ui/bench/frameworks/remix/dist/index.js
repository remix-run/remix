...
// ../../../src/runtime/stream-directives.ts
var PROCESSING_INSTRUCTION_NODE = 7;
var COMMENT_NODE = 8;
var NAME_ATTR_PATTERN = /name="([^"]*)"/;
function getStreamDirective(node) {
  if (!node) return null;
...
var COMPLETE_TEMPLATE_WITH_ID_PATTERN = /<template\b[^>]*\bfor=(?:"([^"]+)"|'([^']+)')[^>]*>[\s\S]*?<\/template>/gi;

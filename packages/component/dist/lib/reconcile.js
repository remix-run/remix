...
function insert(node, domParent, frame, scheduler, styles, vParent, rootTarget, anchor, cursor) {
    ...
    if (isHostNode(node)) {
        ...
        if (exitingNode) {
            reclaimExitingNode(exitingNode, node, domParent, frame, scheduler, styles, vParent, rootTarget);
            return cursor;
        }
...
export function cleanupDescendants(node, scheduler, styles) {
...
function reclaimExitingNode(exitingNode, newNode, domParent, frame, scheduler, styles, vParent, rootTarget) {
    ...
    // Diff children
    diffChildren(exitingNode._children, newNode._children, exitingNode._dom, frame, scheduler, styles, newNode, rootTarget);

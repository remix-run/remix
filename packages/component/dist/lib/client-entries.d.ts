 ...
 * ```
 */
export declare function clientEntry<context = NoContext, setup extends SerializableValue = undefined, props extends SerializableProps = {}>(entryId: string, component: (handle: Handle<context>, setup: setup) => (props: props) => RemixNode): EntryComponent<context, setup, props>;
/**

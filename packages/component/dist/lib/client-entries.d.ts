 ...
 */
export type EntryComponent<context = NoContext, setup = undefined, props = {}> = ((handle: Handle<context>, setup: setup) => (props: props) => RemixNode) & EntryMetadata;
/**
 ...
 * ```
 */
export declare function clientEntry<context = NoContext, setup extends SerializableValue = undefined, props extends SerializableProps = {}>(href: string | AssetMetadata, component: (handle: Handle<context>, setup: setup) => (props: props) => RemixNode): EntryComponent<context, setup, props>;
/**

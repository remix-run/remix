 ...
 */
export declare function jsx(type: string, props: ElementProps, key?: string): RemixElement;
/**
 ...
 * @returns A Remix virtual element.
 */
export declare function jsx(type: Function, props: ElementProps, key?: string): RemixElement;
...
declare global {
    namespace JSX {
        ...
        type ElementType = keyof IntrinsicElements | ((handle: Handle<any>, setup: any) => RenderFn<any>);
        ...
        type LibraryManagedAttributes<component, props> = component extends (handle: Handle<any>, setup: infer S) => RenderFn<infer R> ? // It's a ComponentFactory - combine setup + props
        (unknown extends S ? {} : undefined extends S ? {
            setup?: S;
        } : {
            setup: S;
        }) & ExpandMixProp<R> : ExpandMixProp<props>;

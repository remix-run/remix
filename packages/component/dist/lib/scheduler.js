...
import { findNextSiblingDomAnchor, setActiveSchedulerUpdateParents } from "./reconcile-anchors.js";
import { renderComponent } from "./reconcile.js";
    ...
    function flush() {
        ...
        if (batch.size > 0) {
            ...
            for (let [vnode, domParent] of vnodes) {
                ...
                try {
                    renderComponent(handle, curr, vnode, domParent, handle.frame, scheduler, styles, rootTarget, vParent, anchor);
                }
                catch (error) {
                    dispatchError(error);
                }

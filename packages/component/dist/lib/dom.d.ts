...
export type PresenceStyleProperties = {
    [K in keyof Omit<CSSStyleDeclaration, 'length' | 'parentRule' | 'cssFloat' | 'cssText' | 'item' | 'setProperty' | 'removeProperty' | 'getPropertyValue' | 'getPropertyPriority' | typeof Symbol.iterator>]?: string | number;
};
/**
...
export interface SVGProps<eventTarget extends EventTarget = SVGElement> extends HTMLProps<eventTarget> {
    ...
    alignmentBaseline?: Trackable<'auto' | 'baseline' | 'before-edge' | 'text-before-edge' | 'middle' | 'central' | 'after-edge' | 'text-after-edge' | 'ideographic' | 'alphabetic' | 'hanging' | 'mathematical' | 'inherit' | undefined>;
    'alignment-baseline'?: Trackable<'auto' | 'baseline' | 'before-edge' | 'text-before-edge' | 'middle' | 'central' | 'after-edge' | 'text-after-edge' | 'ideographic' | 'alphabetic' | 'hanging' | 'mathematical' | 'inherit' | undefined>;
...
export interface AriaProps {
    ...
    'aria-current'?: Trackable<Booleanish | 'page' | 'step' | 'location' | 'date' | 'time' | undefined>;
    /**
    ...
    'aria-haspopup'?: Trackable<Booleanish | 'menu' | 'listbox' | 'tree' | 'grid' | 'dialog' | undefined>;
    /**
     ...
     * @see aria-atomic.
     */
    'aria-relevant'?: Trackable<'additions' | 'additions removals' | 'additions text' | 'all' | 'removals' | 'removals additions' | 'removals text' | 'text' | 'text additions' | 'text removals' | undefined>;
...
export interface AllHTMLProps<eventTarget extends EventTarget = EventTarget> extends HostProps<eventTarget>, AriaProps {
    ...
    enctype?: Trackable<string | undefined>;
    enterkeyhint?: Trackable<'enter' | 'done' | 'go' | 'next' | 'previous' | 'search' | 'send' | undefined>;
    ...
    readOnly?: Trackable<boolean | undefined>;
    referrerpolicy?: Trackable<'no-referrer' | 'no-referrer-when-downgrade' | 'origin' | 'origin-when-cross-origin' | 'same-origin' | 'strict-origin' | 'strict-origin-when-cross-origin' | 'unsafe-url' | undefined>;
    ...
    autocapitalize?: Trackable<'off' | 'none' | 'on' | 'sentences' | 'words' | 'characters' | undefined>;
    autoCapitalize?: Trackable<'off' | 'none' | 'on' | 'sentences' | 'words' | 'characters' | undefined>;
...
export interface HTMLProps<eventTarget extends EventTarget = EventTarget> extends HostProps<eventTarget>, AriaProps {
    accesskey?: Trackable<string | undefined>;
    accessKey?: Trackable<string | undefined>;
    autocapitalize?: Trackable<'off' | 'none' | 'on' | 'sentences' | 'words' | 'characters' | undefined>;
    autoCapitalize?: Trackable<'off' | 'none' | 'on' | 'sentences' | 'words' | 'characters' | undefined>;
...
export interface PartialAnchorHTMLProps<eventTarget extends EventTarget> extends HTMLProps<eventTarget> {
...
export type AnchorAriaRoles = {
    ...
    role?: Trackable<'link' | 'button' | 'checkbox' | 'menuitem' | 'menuitemcheckbox' | 'menuitemradio' | 'option' | 'radio' | 'switch' | 'tab' | 'treeitem' | 'doc-backlink' | 'doc-biblioref' | 'doc-glossref' | 'doc-noteref' | undefined>;
} | {
    href?: never;
    role?: Trackable<AriaRole | undefined>;
};
export type AccessibleAnchorHTMLProps<eventTarget extends EventTarget = HTMLAnchorElement> = Omit<PartialAnchorHTMLProps<eventTarget>, 'role'> & AnchorAriaRoles;
export interface AnchorHTMLProps<eventTarget extends EventTarget = HTMLAnchorElement> extends PartialAnchorHTMLProps<eventTarget> {
    href?: Trackable<string | undefined>;
    role?: Trackable<AriaRole | undefined>;
}
export interface PartialAreaHTMLProps<eventTarget extends EventTarget> extends HTMLProps<eventTarget> {
    alt?: Trackable<string | undefined>;
    coords?: Trackable<string | undefined>;
    download?: Trackable<any>;
    hreflang?: Trackable<string | undefined>;
...
export type AccessibleAreaHTMLProps<eventTarget extends EventTarget = HTMLAreaElement> = Omit<PartialAreaHTMLProps<eventTarget>, 'role'> & AreaAriaRoles;
export interface AreaHTMLProps<eventTarget extends EventTarget = HTMLAreaElement> extends PartialAreaHTMLProps<eventTarget> {
    href?: Trackable<string | undefined>;
    role?: Trackable<'button' | 'link' | undefined>;
}
export interface ArticleHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'article' | 'application' | 'document' | 'feed' | 'main' | 'none' | 'presentation' | 'region' | undefined>;
}
export interface AsideHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'complementary' | 'feed' | 'none' | 'note' | 'presentation' | 'region' | 'search' | 'doc-dedication' | 'doc-example' | 'doc-footnote' | 'doc-glossary' | 'doc-pullquote' | 'doc-tip' | undefined>;
}
export interface AudioHTMLProps<eventTarget extends EventTarget = HTMLAudioElement> extends MediaHTMLProps<eventTarget> {
    role?: Trackable<'application' | undefined>;
}
export interface BaseHTMLProps<eventTarget extends EventTarget = HTMLBaseElement> extends HTMLProps<eventTarget> {
    href?: Trackable<string | undefined>;
    role?: never;
    target?: Trackable<HTMLAttributeAnchorTarget | undefined>;
}
export interface BlockquoteHTMLProps<eventTarget extends EventTarget = HTMLQuoteElement> extends HTMLProps<eventTarget> {
    cite?: Trackable<string | undefined>;
}
export interface BrHTMLProps<eventTarget extends EventTarget = HTMLBRElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'none' | 'presentation' | undefined>;
}
export interface ButtonHTMLProps<eventTarget extends EventTarget = HTMLButtonElement> extends HTMLProps<eventTarget> {
    ...
    popovertargetaction?: Trackable<'hide' | 'show' | 'toggle' | undefined>;
    popoverTargetAction?: Trackable<'hide' | 'show' | 'toggle' | undefined>;
    role?: Trackable<'button' | 'checkbox' | 'combobox' | 'gridcell' | 'link' | 'menuitem' | 'menuitemcheckbox' | 'menuitemradio' | 'option' | 'radio' | 'separator' | 'slider' | 'switch' | 'tab' | 'treeitem' | undefined>;
    type?: Trackable<'submit' | 'reset' | 'button' | undefined>;
    value?: Trackable<string | number | undefined>;
}
export interface CanvasHTMLProps<eventTarget extends EventTarget = HTMLCanvasElement> extends HTMLProps<eventTarget> {
    height?: Trackable<number | string | undefined>;
    width?: Trackable<number | string | undefined>;
}
export interface CaptionHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: 'caption';
}
export interface ColHTMLProps<eventTarget extends EventTarget = HTMLTableColElement> extends HTMLProps<eventTarget> {
    role?: never;
    span?: Trackable<number | undefined>;
    width?: Trackable<number | string | undefined>;
}
export interface ColgroupHTMLProps<eventTarget extends EventTarget = HTMLTableColElement> extends HTMLProps<eventTarget> {
    role?: never;
    span?: Trackable<number | undefined>;
}
export interface DataHTMLProps<eventTarget extends EventTarget = HTMLDataElement> extends HTMLProps<eventTarget> {
    value?: Trackable<string | number | undefined>;
}
export interface DataListHTMLProps<eventTarget extends EventTarget = HTMLDataListElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'listbox' | undefined>;
}
export interface DdHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: never;
}
export interface DelHTMLProps<eventTarget extends EventTarget = HTMLModElement> extends HTMLProps<eventTarget> {
    cite?: Trackable<string | undefined>;
    datetime?: Trackable<string | undefined>;
    dateTime?: Trackable<string | undefined>;
}
export interface DetailsHTMLProps<eventTarget extends EventTarget = HTMLDetailsElement> extends HTMLProps<eventTarget> {
    name?: Trackable<string | undefined>;
    open?: Trackable<boolean | undefined>;
    role?: Trackable<'group' | undefined>;
}
export interface DialogHTMLProps<eventTarget extends EventTarget = HTMLDialogElement> extends HTMLProps<eventTarget> {
    open?: Trackable<boolean | undefined>;
    closedby?: Trackable<'none' | 'closerequest' | 'any' | undefined>;
    closedBy?: Trackable<'none' | 'closerequest' | 'any' | undefined>;
    role?: Trackable<'dialog' | 'alertdialog' | undefined>;
}
export interface DlHTMLProps<eventTarget extends EventTarget = HTMLDListElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'group' | 'list' | 'none' | 'presentation' | undefined>;
}
export interface DtHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'listitem' | undefined>;
}
export interface EmbedHTMLProps<eventTarget extends EventTarget = HTMLEmbedElement> extends HTMLProps<eventTarget> {
    height?: Trackable<number | string | undefined>;
...
export interface FieldsetHTMLProps<eventTarget extends EventTarget = HTMLFieldSetElement> extends HTMLProps<eventTarget> {
    disabled?: Trackable<boolean | undefined>;
    form?: Trackable<string | undefined>;
    name?: Trackable<string | undefined>;
    role?: Trackable<'group' | 'none' | 'presentation' | 'radiogroup' | undefined>;
}
export interface FigcaptionHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'group' | 'none' | 'presentation' | undefined>;
}
export interface FooterHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'contentinfo' | 'group' | 'none' | 'presentation' | 'doc-footnote' | undefined>;
}
export interface FormHTMLProps<eventTarget extends EventTarget = HTMLFormElement> extends HTMLProps<eventTarget> {
...
export interface HeadingHTMLProps<eventTarget extends EventTarget = HTMLHeadingElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'heading' | 'none' | 'presentation' | 'tab' | 'doc-subtitle' | undefined>;
}
export interface HeadHTMLProps<eventTarget extends EventTarget = HTMLHeadElement> extends HTMLProps<eventTarget> {
    role?: never;
}
export interface HeaderHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'banner' | 'group' | 'none' | 'presentation' | undefined>;
}
export interface HrHTMLProps<eventTarget extends EventTarget = HTMLHRElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'separator' | 'none' | 'presentation' | 'doc-pagebreak' | undefined>;
}
export interface HtmlHTMLProps<eventTarget extends EventTarget = HTMLHtmlElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'document' | undefined>;
}
export interface IframeHTMLProps<eventTarget extends EventTarget = HTMLIFrameElement> extends HTMLProps<eventTarget> {
    allow?: Trackable<string | undefined>;
    allowFullScreen?: Trackable<boolean | undefined>;
    allowTransparency?: Trackable<boolean | undefined>;
    /** @deprecated */
...
export interface PartialImgHTMLProps<eventTarget extends EventTarget> extends HTMLProps<eventTarget> {
...
export type ImgAriaRolesAccessibleName = Trackable<'img' | 'button' | 'checkbox' | 'link' | 'menuitem' | 'menuitemcheckbox' | 'menuitemradio' | 'meter' | 'option' | 'progressbar' | 'radio' | 'scrollbar' | 'separator' | 'slider' | 'switch' | 'tab' | 'treeitem' | 'doc-cover' | undefined>;
...
export type AccessibleImgHTMLProps<eventTarget extends EventTarget = HTMLImageElement> = Omit<PartialImgHTMLProps<eventTarget>, 'role' | 'aria-label' | 'aria-labelledby' | 'title'> & ImgAriaRoles;
export interface ImgHTMLProps<eventTarget extends EventTarget = HTMLImageElement> extends PartialImgHTMLProps<eventTarget> {
    alt?: Trackable<string | undefined>;
    'aria-label'?: Trackable<string | undefined>;
    'aria-labelledby'?: Trackable<string | undefined>;
    href?: Trackable<string | undefined>;
...
export interface PartialInputHTMLProps<eventTarget extends EventTarget> extends HTMLProps<eventTarget> {
    accept?: Trackable<string | undefined>;
    alt?: Trackable<string | undefined>;
    autocomplete?: Trackable<string | undefined>;
    autoComplete?: Trackable<string | undefined>;
    capture?: Trackable<'user' | 'environment' | undefined>;
    checked?: Trackable<boolean | undefined>;
    defaultChecked?: Trackable<boolean | undefined>;
...
export type InputAriaRoles = {
    ...
    role?: Trackable<'button' | 'checkbox' | 'gridcell' | 'link' | 'menuitem' | 'menuitemcheckbox' | 'menuitemradio' | 'option' | 'separator' | 'slider' | 'switch' | 'tab' | 'treeitem' | undefined>;
} | {
    ...
    type: Trackable<'color' | 'date' | 'datetime-local' | 'file' | 'hidden' | 'month' | 'password' | 'time' | 'week'>;
    role?: never;
};
export type AccessibleInputHTMLProps<eventTarget extends EventTarget = HTMLInputElement> = Omit<PartialInputHTMLProps<eventTarget>, 'role'> & InputAriaRoles;
export interface InputHTMLProps<eventTarget extends EventTarget = HTMLInputElement> extends PartialInputHTMLProps<eventTarget> {
    type?: Trackable<HTMLInputTypeAttribute | undefined>;
    role?: Trackable<'button' | 'checkbox' | 'combobox' | 'gridcell' | 'link' | 'menuitem' | 'menuitemcheckbox' | 'menuitemradio' | 'option' | 'radio' | 'searchbox' | 'separator' | 'slider' | 'spinbutton' | 'switch' | 'tab' | 'textbox' | 'treeitem' | undefined>;
}
export interface InsHTMLProps<eventTarget extends EventTarget = HTMLModElement> extends HTMLProps<eventTarget> {
    cite?: Trackable<string | undefined>;
    datetime?: Trackable<string | undefined>;
    dateTime?: Trackable<string | undefined>;
}
export interface KeygenHTMLProps<eventTarget extends EventTarget = HTMLUnknownElement> extends HTMLProps<eventTarget> {
    challenge?: Trackable<string | undefined>;
    disabled?: Trackable<boolean | undefined>;
    form?: Trackable<string | undefined>;
    keyType?: Trackable<string | undefined>;
...
export interface LabelHTMLProps<eventTarget extends EventTarget = HTMLLabelElement> extends HTMLProps<eventTarget> {
    for?: Trackable<string | undefined>;
    form?: Trackable<string | undefined>;
    htmlFor?: Trackable<string | undefined>;
    role?: never;
}
export interface LegendHTMLProps<eventTarget extends EventTarget = HTMLLegendElement> extends HTMLProps<eventTarget> {
    role?: never;
}
export interface LiHTMLProps<eventTarget extends EventTarget = HTMLLIElement> extends HTMLProps<eventTarget> {
    value?: Trackable<string | number | undefined>;
}
export interface LinkHTMLProps<eventTarget extends EventTarget = HTMLLinkElement> extends HTMLProps<eventTarget> {
    as?: Trackable<string | undefined>;
    crossorigin?: Trackable<HTMLAttributeCrossOrigin>;
    crossOrigin?: Trackable<HTMLAttributeCrossOrigin>;
...
export interface MainHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'main' | undefined>;
}
export interface MapHTMLProps<eventTarget extends EventTarget = HTMLMapElement> extends HTMLProps<eventTarget> {
    name?: Trackable<string | undefined>;
    role?: never;
}
export interface MarqueeHTMLProps<eventTarget extends EventTarget = HTMLMarqueeElement> extends HTMLProps<eventTarget> {
...
export interface MediaHTMLProps<eventTarget extends EventTarget = HTMLMediaElement> extends HTMLProps<eventTarget> {
    autoplay?: Trackable<boolean | undefined>;
    autoPlay?: Trackable<boolean | undefined>;
    controls?: Trackable<boolean | undefined>;
    controlslist?: Trackable<string | undefined>;
...
export interface MenuHTMLProps<eventTarget extends EventTarget = HTMLMenuElement> extends HTMLProps<eventTarget> {
    role: 'list' | 'group' | 'listbox' | 'menu' | 'menubar' | 'none' | 'presentation' | 'radiogroup' | 'tablist' | 'toolbar' | 'tree';
    type?: Trackable<string | undefined>;
}
export interface MetaHTMLProps<eventTarget extends EventTarget = HTMLMetaElement> extends HTMLProps<eventTarget> {
    charset?: Trackable<string | undefined>;
    charSet?: Trackable<string | undefined>;
    content?: Trackable<string | undefined>;
    'http-equiv'?: Trackable<string | undefined>;
...
export interface MeterHTMLProps<eventTarget extends EventTarget = HTMLMeterElement> extends HTMLProps<eventTarget> {
    form?: Trackable<string | undefined>;
    high?: Trackable<number | undefined>;
    low?: Trackable<number | undefined>;
    max?: Trackable<number | string | undefined>;
...
export interface NavHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'navigation' | 'menu' | 'menubar' | 'none' | 'presentation' | 'tablist' | undefined>;
}
export interface NoScriptHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: never;
}
export interface ObjectHTMLProps<eventTarget extends EventTarget = HTMLObjectElement> extends HTMLProps<eventTarget> {
...
export interface OlHTMLProps<eventTarget extends EventTarget = HTMLOListElement> extends HTMLProps<eventTarget> {
    reversed?: Trackable<boolean | undefined>;
    role?: Trackable<'list' | 'group' | 'listbox' | 'menu' | 'menubar' | 'none' | 'presentation' | 'radiogroup' | 'tablist' | 'toolbar' | 'tree' | undefined>;
    start?: Trackable<number | undefined>;
    type?: Trackable<'1' | 'a' | 'A' | 'i' | 'I' | undefined>;
}
export interface OptgroupHTMLProps<eventTarget extends EventTarget = HTMLOptGroupElement> extends HTMLProps<eventTarget> {
    disabled?: Trackable<boolean | undefined>;
    label?: Trackable<string | undefined>;
    role?: Trackable<'group' | undefined>;
}
export interface OptionHTMLProps<eventTarget extends EventTarget = HTMLOptionElement> extends HTMLProps<eventTarget> {
    disabled?: Trackable<boolean | undefined>;
    label?: Trackable<string | undefined>;
...
export interface OutputHTMLProps<eventTarget extends EventTarget = HTMLOutputElement> extends HTMLProps<eventTarget> {
    for?: Trackable<string | undefined>;
    form?: Trackable<string | undefined>;
    htmlFor?: Trackable<string | undefined>;
    name?: Trackable<string | undefined>;
}
export interface ParamHTMLProps<eventTarget extends EventTarget = HTMLParamElement> extends HTMLProps<eventTarget> {
    name?: Trackable<string | undefined>;
    role?: never;
    value?: Trackable<string | number | undefined>;
}
export interface PictureHTMLProps<eventTarget extends EventTarget = HTMLPictureElement> extends HTMLProps<eventTarget> {
    role?: never;
}
export interface ProgressHTMLProps<eventTarget extends EventTarget = HTMLProgressElement> extends HTMLProps<eventTarget> {
    max?: Trackable<number | string | undefined>;
    role?: Trackable<'progressbar' | undefined>;
    value?: Trackable<string | number | undefined>;
}
export interface QuoteHTMLProps<eventTarget extends EventTarget = HTMLQuoteElement> extends HTMLProps<eventTarget> {
    cite?: Trackable<string | undefined>;
}
export interface ScriptHTMLProps<eventTarget extends EventTarget = HTMLScriptElement> extends HTMLProps<eventTarget> {
    async?: Trackable<boolean | undefined>;
    /** @deprecated */
    charset?: Trackable<string | undefined>;
    /** @deprecated */
...
export interface SearchHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'search' | 'form' | 'group' | 'none' | 'presentation' | 'region' | undefined>;
}
export interface PartialSelectHTMLProps<eventTarget extends EventTarget> extends HTMLProps<eventTarget> {
    autocomplete?: Trackable<string | undefined>;
    autoComplete?: Trackable<string | undefined>;
    defaultValue?: Trackable<string | number | undefined>;
    disabled?: Trackable<boolean | undefined>;
...
export type AccessibleSelectHTMLProps<eventTarget extends EventTarget = HTMLSelectElement> = Omit<PartialSelectHTMLProps<eventTarget>, 'role'> & SelectAriaRoles;
export interface SelectHTMLProps<eventTarget extends EventTarget = HTMLSelectElement> extends PartialSelectHTMLProps<eventTarget> {
    multiple?: Trackable<boolean | undefined>;
    size?: Trackable<number | undefined>;
    type?: Trackable<HTMLInputTypeAttribute | undefined>;
    role?: Trackable<'combobox' | 'listbox' | 'menu' | undefined>;
}
export interface SlotHTMLProps<eventTarget extends EventTarget = HTMLSlotElement> extends HTMLProps<eventTarget> {
    name?: Trackable<string | undefined>;
    role?: never;
}
export interface SourceHTMLProps<eventTarget extends EventTarget = HTMLSourceElement> extends HTMLProps<eventTarget> {
    height?: Trackable<number | string | undefined>;
    media?: Trackable<string | undefined>;
    role?: never;
    sizes?: Trackable<string | undefined>;
...
export interface StyleHTMLProps<eventTarget extends EventTarget = HTMLStyleElement> extends HTMLProps<eventTarget> {
    media?: Trackable<string | undefined>;
    role?: never;
    scoped?: Trackable<boolean | undefined>;
    type?: Trackable<string | undefined>;
}
export interface TableHTMLProps<eventTarget extends EventTarget = HTMLTableElement> extends HTMLProps<eventTarget> {
    cellPadding?: Trackable<string | undefined>;
    cellSpacing?: Trackable<string | undefined>;
    summary?: Trackable<string | undefined>;
    width?: Trackable<number | string | undefined>;
}
export interface TdHTMLProps<eventTarget extends EventTarget = HTMLTableCellElement> extends HTMLProps<eventTarget> {
...
export interface TemplateHTMLProps<eventTarget extends EventTarget = HTMLTemplateElement> extends HTMLProps<eventTarget> {
    role?: never;
}
export interface TextareaHTMLProps<eventTarget extends EventTarget = HTMLTextAreaElement> extends HTMLProps<eventTarget> {
    autocomplete?: Trackable<string | undefined>;
    autoComplete?: Trackable<string | undefined>;
    cols?: Trackable<number | undefined>;
    defaultValue?: Trackable<string | number | undefined>;
...
export interface ThHTMLProps<eventTarget extends EventTarget = HTMLTableCellElement> extends HTMLProps<eventTarget> {
    align?: Trackable<'left' | 'center' | 'right' | 'justify' | 'char' | undefined>;
    colspan?: Trackable<number | undefined>;
    colSpan?: Trackable<number | undefined>;
    headers?: Trackable<string | undefined>;
...
export interface TimeHTMLProps<eventTarget extends EventTarget = HTMLTimeElement> extends HTMLProps<eventTarget> {
    datetime?: Trackable<string | undefined>;
    dateTime?: Trackable<string | undefined>;
}
export interface TitleHTMLProps<eventTarget extends EventTarget = HTMLTitleElement> extends HTMLProps<eventTarget> {
    role?: never;
}
export interface TrackHTMLProps<eventTarget extends EventTarget = HTMLTrackElement> extends MediaHTMLProps<eventTarget> {
    default?: Trackable<boolean | undefined>;
    kind?: Trackable<string | undefined>;
    label?: Trackable<string | undefined>;
    role?: never;
...
export interface UlHTMLProps<eventTarget extends EventTarget = HTMLUListElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'list' | 'group' | 'listbox' | 'menu' | 'menubar' | 'none' | 'presentation' | 'radiogroup' | 'tablist' | 'toolbar' | 'tree' | undefined>;
}
export interface VideoHTMLProps<eventTarget extends EventTarget = HTMLVideoElement> extends MediaHTMLProps<eventTarget> {
    disablePictureInPicture?: Trackable<boolean | undefined>;
    height?: Trackable<number | string | undefined>;
    playsinline?: Trackable<boolean | undefined>;
    playsInline?: Trackable<boolean | undefined>;
...
export interface WbrHTMLProps<eventTarget extends EventTarget = HTMLElement> extends HTMLProps<eventTarget> {
    role?: Trackable<'none' | 'presentation' | undefined>;
}
export type DetailedHTMLProps<HA extends HTMLProps<RefType>, RefType extends EventTarget = EventTarget> = HA;
export interface MathMLProps<eventTarget extends EventTarget = MathMLElement> extends HTMLProps<eventTarget> {
...
export interface AnnotationMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
...
export interface AnnotationXmlMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
    encoding?: Trackable<string | undefined>;
    /** @deprecated See https://developer.mozilla.org/en-US/docs/Web/MathML/Element/semantics#src */
    src?: Trackable<string | undefined>;
}
export interface MActionMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
...
export interface MEncloseMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
    notation?: Trackable<string | undefined>;
}
export interface MErrorMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
}
export interface MFencedMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
    close?: Trackable<string | undefined>;
    open?: Trackable<string | undefined>;
    separators?: Trackable<string | undefined>;
}
export interface MFracMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
...
export interface MiMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
     ...
     */
    mathvariant?: Trackable<'normal' | 'bold' | 'italic' | 'bold-italic' | 'double-struck' | 'bold-fraktur' | 'script' | 'bold-script' | 'fraktur' | 'sans-serif' | 'bold-sans-serif' | 'sans-serif-italic' | 'sans-serif-bold-italic' | 'monospace' | 'initial' | 'tailed' | 'looped' | 'stretched' | undefined>;
}
export interface MmultiScriptsMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
...
export interface MOverMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
    accent?: Trackable<boolean | undefined>;
}
export interface MPaddedMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
...
export interface MPhantomMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
}
export interface MPrescriptsMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
}
export interface MRootMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
}
export interface MRowMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
}
...
export interface MSpaceMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
    depth?: Trackable<string | undefined>;
    height?: Trackable<string | undefined>;
    width?: Trackable<string | undefined>;
}
export interface MSqrtMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
}
export interface MStyleMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
...
export interface MSubsupMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
...
export interface MTableMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
...
export interface MTextMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
}
...
export interface MUnderMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
    accentunder?: Trackable<boolean | undefined>;
}
export interface MUnderoverMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
    accent?: Trackable<boolean | undefined>;
    accentunder?: Trackable<boolean | undefined>;
}
export interface SemanticsMathMLProps<eventTarget extends EventTarget> extends MathMLProps<eventTarget> {
}
export {};

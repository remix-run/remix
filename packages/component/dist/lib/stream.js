...
function resolveSsrMixedProps(hostType, initialProps, context) {
...
function resolveSsrMixinRunner(hostType, descriptor, context) {
...
function createSsrMixinHandle(hostType, context) {
...
function resolveSsrMixDescriptors(props) {
    let mix = props.mix;
    if (mix == null || !Array.isArray(mix) || mix.length === 0)
        return [];
    return [...mix];
}

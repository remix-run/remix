...
/**
 * Options for createHydrationRoot
 */
...
/**
 * Create a hydration root that manages all hydrated components in the document.
 *
 * This function:
 ...
 * ```
 */
export function createHydrationRoot(options?: HydrationRootOptions): HydrationRoot {

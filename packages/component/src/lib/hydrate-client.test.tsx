...
import { hydrate } from './hydrated.ts'
import { createHydrationRoot } from './hydrate-client.ts'
...
describe('createHydrationRoot', () => {
  ...
  it('hydrates a single component', async () => {
    ...
    // Hydrate
    let root = createHydrationRoot({ loadModule })
    await root.ready
  ...
  it('hydrates multiple components', async () => {
    let Button = hydrate('/js/button.js#Button', function Button(handle: Handle) {
      let clicked = false
  ...
  it('handles complex props', async () => {
    let Card = hydrate('/js/card.js#Card', function Card(handle: Handle) {
  ...
  it('handles module load errors gracefully', async () => {
    let Counter = hydrate('/js/counter.js#Counter', function Counter() {
  ...
  it('loads modules in parallel', async () => {
    let Button = hydrate('/js/button.js#Button', function Button() {
  ...
  it('flush works before ready resolves', async () => {
    let Counter = hydrate('/js/counter.js#Counter', function Counter(handle: Handle) {
      let count = 0
      return () => (
        <button
          on={{

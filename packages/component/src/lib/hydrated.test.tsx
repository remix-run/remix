...
import { hydrate, isHydratedComponent } from './hydrated.ts'
...
describe('hydrated', () => {
  describe('types', () => {
    it('keeps original types', () => {
      ...
      let HydratedInput = hydrate('/js/test.js#Input', Input)
    ...
    it('only allows serializable props', () => {
      ...
      // @ts-expect-error - should disallow non-serializable function prop
      let HydratedInput2 = hydrate('/js/test.js#Input', Input2)
  ...
  describe('basic functionality', () => {
    it('marks a component as hydrated', () => {
      ...
      let HydratedComponent = hydrate('/js/test.js#TestComponent', TestComponent)
    ...
    it('parses module URL and export name from href', () => {
      ...
      let HydratedComponent = hydrate('/js/components.js#MyComponent', MyComponent)
    ...
    it('uses component name as fallback when no export name provided', () => {
      ...
      let HydratedComponent = hydrate('/js/components.js', NamedComponent)
  ...
  describe('error handling', () => {
    ...
    it('throws error when no export name and component is anonymous', () => {
      ...
      expect(() => {
        hydrate('/js/test.js', anonymousComponent)
    ...
    it('throws error when no export name and component name is empty', () => {
      ...
      expect(() => {
        hydrate('/js/test.js', TestComponent)
      }).toThrow('hydrated() requires either an export name in the href')
    })
  })
  ...
  describe('type constraints', () => {
    it('accepts components with serializable props', () => {
      ...
      let HydratedComponent = hydrate('/js/valid.js#ValidComponent', ValidComponent)
      expect(HydratedComponent.$hydrated).toBe(true)
    })
    ...
    it('rejects components with non-serializable props', () => {
      ...
      let HydratedInvalid = hydrate('/js/invalid.js#InvalidComponent', InvalidComponent)
      expect(true).toBe(true)
    })
    ...
    it('accepts primitive setup types', () => {
      ...
      let HydratedCounter = hydrate('/js/counter.js#Counter', Counter)
    ...
    it('accepts null and undefined setup types', () => {
      ...
      let HydratedNull = hydrate('/js/null.js#NullSetup', NullSetup)
      let HydratedUndefined = hydrate('/js/undefined.js#UndefinedSetup', UndefinedSetup)
    ...
    it('accepts array setup types', () => {
      ...
      let HydratedArray = hydrate('/js/array.js#ArraySetup', ArraySetup)
  ...
  describe('complex components', () => {
    ...
    it('handles simple components that return JSX directly', () => {
      ...
      let HydratedSimple = hydrate('/js/simple.js#SimpleComponent', SimpleComponent)

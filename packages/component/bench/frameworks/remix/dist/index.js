...
function createStyleManager(layer = "rmx") {
  ...
  return { insert: insert2, remove: remove3, has, reset, adoptServerStyles, dispose };
}
...
// ../../../src/lib/mixins/attrs-mixin.tsx
...
// ../../../src/lib/mixins/animate-mixins.ts
var DEFAULT_ENTER = {
  opacity: 0,
  duration: 150,
  easing: "ease-out"
...
// ../../../src/lib/mixins/animate-layout-mixin.ts

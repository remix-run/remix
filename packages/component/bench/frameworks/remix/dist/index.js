...
// ../../../src/lib/host-content-mode.ts
function getHostContentMode(props) {
  return props.innerHTML != null ? "innerHTML" : "children";
}
function getCanonicalHostChildren(mode, children) {
...
// ../../../src/lib/reconcile-frame.ts
function insertFrame(node, domParent, frame, styles, vParent, anchor, cursor) {
...
function resolveMixDescriptors(props) {
  let mix2 = props.mix;
  if (mix2 == null || !Array.isArray(mix2) || mix2.length === 0) return [];
  return [...mix2];
}
...
// ../../../src/lib/virtual-root.ts
function createVirtualRoot(init) {
  let vroot = null;
  ...
  let scheduler = init.scheduler ?? createScheduler(init.container.ownerDocument ?? document, eventTarget, styles);
  ...
  return Object.assign(eventTarget, {
    ...
    dispose() {
      ...
      let current = vroot;
      vroot = null;
      scheduler.enqueueTasks([() => remove2(current, init.container, scheduler, styles)]);
      scheduler.dequeue();
    },
    flush() {
      scheduler.dequeue();
...
function createRoot(container, options = {}) {
  ...
  return createVirtualRoot({
    ...
    scheduler: options.scheduler,
    styleManager,
    hydrationCursor: container.innerHTML.trim() !== "" ? container.firstChild : void 0,
    createFrame(scheduler, frameStyleManager) {
      return createRootFrameHandle({
        src: options.frameInit?.src,
        resolveFrame: options.frameInit?.resolveFrame,

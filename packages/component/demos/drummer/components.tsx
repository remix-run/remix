export function Layout({ children }: { children: Remix.Node }) {
  return (
    <div
      css={{
...
export function EqualizerLayout({ children }: { children: Remix.Node }) {
  return (
    <div
      css={{
        display: 'flex',
...
export function TempoLayout({ children }: { children: Remix.Node }) {
  return (
    <div
      css={{
        display: 'flex',
...
export function TempoButtons({ children }: { children: Remix.Node }) {
  return (
    <div
      css={{
        width: 75,
...
export function BPMDisplay(this: Remix.Handle, { bpm }: { bpm: number }) {
  return (
    <div
      css={{
        height: '100%',

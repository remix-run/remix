import { animateEntrance, animateExit, type Handle } from 'remix/component'
    ...
    >
      {props.state === 'processing' && (
        <span
          ...
          mix={[animateEntrance(iconAnimation.enter), animateExit(iconAnimation.exit)]}
        >
          <Loader />
        </span>
      )}
      ...
      >
        ...
        {props.state === 'idle' && (
          <span
            ...
            mix={[animateEntrance(labelAnimation.enter), animateExit(labelAnimation.exit)]}
          >
            {STATES.idle}
          </span>
        )}

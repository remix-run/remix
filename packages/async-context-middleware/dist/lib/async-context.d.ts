...
type RequestContextWithAnyParams<context> = context extends RequestContext<any, infer entries extends ContextEntries, infer output> ? ContextWithEntries<RequestContext<AnyParams, [], output>, entries> : RequestContext<AnyParams>;

...
export interface EntryRouteModule {
  ...
  ErrorBoundary?: any; // Weakly typed because this package is not React-aware
  HydrateFallback?: any; // Weakly typed because this package is not React-aware
  Layout?: any; // Weakly typed because this package is not React-aware
  default: any; // Weakly typed because this package is not React-aware
  handle?: RouteHandle;
  links?: LinksFunction;

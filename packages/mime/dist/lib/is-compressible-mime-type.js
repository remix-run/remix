import { compressibleMimeTypes } from "../generated/compressible-mime-types.js";
import { customCompressibleByMimeType } from "./define-mime-type.js";
/**
 ...
 */
export function isCompressibleMimeType(mimeType) {
    if (!mimeType)
        return false;

import type { AnyParams, ContextEntries, Middleware, RequestContext, RequestMethod } from '@remix-run/fetch-router';
...
export interface CsrfOriginResolver {
     ...
     */
    (origin: string, context: AnyRequestContext): CsrfOriginResolverResult | Promise<CsrfOriginResolverResult>;
}
/**
 ...
 */
export declare function csrf(options?: CsrfOptions): Middleware<readonly [], Response>;
/**
 ...
 */
export declare function getCsrfToken(context: AnyRequestContext, tokenKey?: string): string;
export {};

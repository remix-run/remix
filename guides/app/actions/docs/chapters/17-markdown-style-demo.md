...
A paragraph can mix **strong text**, _emphasis_, `inline code`, and [links to another chapter](/docs/core-app-structure). Inline code should stay compact enough to read in a sentence without looking like a full code block.
...
::frame{src="/docs/examples/17-markdown-style-demo/callout"}

...
::frame{src="/docs/examples/06-animation/press-state"}
...
::frame{src="/docs/examples/06-animation/spring-drag-release"}

::frame{src="/docs/examples/06-animation/bouncy-switch"}
...
::frame{src="/docs/examples/06-animation/animation-gallery"}

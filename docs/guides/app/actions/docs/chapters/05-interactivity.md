...
navigations through the browser's History API. Cross-origin links, downloads, and navigations the
runtime cannot intercept continue as normal document requests.

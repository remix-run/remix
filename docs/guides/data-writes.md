...
We didn't do much with `navigation` on this page, but it's got all the information about the submission, including all the values being processed on the server in `navigation.formData`.

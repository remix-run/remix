...
While we believe that a strong separation of data and display is important, we understand that formats that mix the two such as [MDX][mdxjs-1] (Markdown with embedded JSX components) have become a popular and powerful authoring format for developers.
...
The lines in the document above between the `---` are called "frontmatter". You can think of them like metadata for your document, formatted as [YAML][yaml-1].
...
[mdxjs-1]: https://mdxjs.com/
[yaml-1]: https://yaml.org/
[github-1]: https://github.com/kentcdodds/mdx-bundler

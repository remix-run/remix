...
[Read the feature announcement blog post][1] and [watch Remix Stacks videos on YouTube][www.youtube-1].
...
- [The Blues Stack][github-1]: Deployed to the edge (distributed) with a long-running Node.js server and PostgreSQL database. Intended for large and fast production-grade applications serving millions of users.
- [The Indie Stack][github-2]: Deployed to a long-running Node.js server with a persistent SQLite database. This stack is great for websites with dynamic data that you control (blogs, marketing, content sites). It's also a perfect, low-complexity bootstrap for MVPs, prototypes, and proof-of-concepts that can later be updated to the Blues stack easily.
- [The Grunge Stack][github-3]: Deployed to a serverless function running Node.js with DynamoDB for persistence. Intended for folks who want to deploy a production-grade application on AWS infrastructure serving millions of users.
...
[1]: /blog/remix-stacks
[www.youtube-1]: https://www.youtube.com/playlist?list=PLXoynULbYuEC8-gJCqyXo94RufAvSA6R3
[github-1]: https://github.com/remix-run/blues-stack
[github-2]: https://github.com/remix-run/indie-stack
[github-3]: https://github.com/remix-run/grunge-stack

...
```tsx filename=app/root.tsx lines=[1,11,13-15]
...
<summary>app/routes/contacts.$contactId.tsx</summary>
...
```tsx filename=app/root.tsx lines=[7,63-65]
import type { LinksFunction } from "@remix-run/node";
import {
  Form,
  Links,
...
```tsx filename=app/root.tsx lines=[4,49,52]
import type { LinksFunction } from "@remix-run/node";
import {
  Form,
  Link,
...
```tsx filename=app/root.tsx lines=[12,16,23-25,28,64-87]
import type { LinksFunction } from "@remix-run/node";
...
```tsx filename=app/root.tsx lines=[28]
import type { LinksFunction } from "@remix-run/node";
import { json } from "@remix-run/node";
import {
  Form,
...
```tsx filename=app/routes/contacts.$contactId.tsx lines=[1,4,9-10]
...
```tsx filename=app/routes/contacts.$contactId.tsx lines=[12-14]
import type { LoaderArgs } from "@remix-run/node";
import { json } from "@remix-run/node";
import { Form, useLoaderData } from "@remix-run/react";
import invariant from "tiny-invariant";
...
```tsx filename=app/root.tsx lines=[16,18-21]
import type { LinksFunction } from "@remix-run/node";
import { json } from "@remix-run/node";
import {
  Form,
...
<summary>app/routes/contacts.$contactId.edit.tsx</summary>
...
<summary>app/routes/contacts.$contactId_.edit.tsx</summary>

```tsx filename=app/routes/contacts.$contactId_.edit.tsx lines=[2,5,9,11-20]
import type {
  ActionArgs,
  LoaderArgs,
} from "@remix-run/node";
...
```tsx filename=app/root.tsx lines=[2,20]
import type { LinksFunction } from "@remix-run/node";
import { json, redirect } from "@remix-run/node";
import {
  Form,
...
```tsx filename=app/root.tsx lines=[8,73-83,96]
import type { LinksFunction } from "@remix-run/node";
import { json, redirect } from "@remix-run/node";
import {
  Form,
...
```tsx filename=app/root.tsx lines=[13,35,111-113]
import type { LinksFunction } from "@remix-run/node";
import { json, redirect } from "@remix-run/node";
import {
  Form,
...
<summary>app/routes/contacts.$contactId.destroy.tsx</summary>
...
```tsx filename=app/routes/contacts.$contactId_.edit.tsx lines=[9,37,87]
import type {
  ActionArgs,
  LoaderArgs,
} from "@remix-run/node";
...
```tsx filename=app/root.tsx lines=[3,31-34]
import type {
  LinksFunction,
  LoaderArgs,
} from "@remix-run/node";
...
```tsx filename=app/root.tsx lines=[35,39,60]
import type {
  LinksFunction,
  LoaderArgs,
} from "@remix-run/node";
...
```tsx filename=app/root.tsx lines=[18,43-48]
import type {
  LinksFunction,
  LoaderArgs,
} from "@remix-run/node";
...
```tsx filename=app/root.tsx lines=[18,42-43,45-49,71-74,77-78]
import type {
  LinksFunction,
  LoaderArgs,
} from "@remix-run/node";
...
```tsx filename=app/root.tsx lines=[17,43,69-71]
import type {
  LinksFunction,
  LoaderArgs,
} from "@remix-run/node";
...
```tsx filename=app/root.tsx lines=[44-48,81,90]
import type {
  LinksFunction,
  LoaderArgs,
} from "@remix-run/node";
...
```tsx filename=app/root.tsx lines=[139]
import type {
  LinksFunction,
  LoaderArgs,
} from "@remix-run/node";
...
```tsx filename=app/root.tsx lines=[75-78]
import type {
  LinksFunction,
  LoaderArgs,
} from "@remix-run/node";
...
```tsx filename=app/routes/contacts.$contactId.tsx lines=[5,89,93,105]
import type { LoaderArgs } from "@remix-run/node";
import { json } from "@remix-run/node";
import {
  Form,
...
```tsx filename=app/routes/contacts.$contactId.tsx lines=[2,14,16-25]
import type {
  ActionArgs,
  LoaderArgs,
} from "@remix-run/node";
...
```tsx filename=app/routes/contacts.$contactId.tsx lines=[104-106]
import type {
  ActionArgs,
  LoaderArgs,
} from "@remix-run/node";
